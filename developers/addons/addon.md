...
| keywords                   | A comma separated list of keywords that are used by the UI search function. e.g. `AwTrixLight,ESPMilight,FalconPlayerFPP,RuuviGateway`                                                                                                                                                                                                                               | optional  |
...
| countries                  | List of two-letter ISO country codes (ISO 3166-1 alpha-2) that are supported (all countries if empty). Must be in lowercase. e.g. `de,nk,dk`                                                                                                                                                                                                                         | optional  |
