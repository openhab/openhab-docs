...
* Add a new line in the [bundle pom.xml](https://github.com/openhab/openhab-addons/blob/2.5.x/bundles/pom.xml) (openhab-addons/bundles/pom.xml).
* Add a new entry in the [binding pom.xml](https://github.com/openhab/openhab-addons/blob/2.5.x/bom/openhab-addons/pom.xml) (openhab-addons/bom/openhab-addons/pom.xml).
...
* Add your binding to the [CODEOWNERS](https://github.com/openhab/openhab-addons/blob/2.5.x/CODEOWNERS) file (openhab-addons/CODEOWNERS) so that you get notified by Github when someone adds a pull request towards your binding.
