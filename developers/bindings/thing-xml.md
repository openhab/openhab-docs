...
| tag                        | A tag semantically describes the feature (typical usage) of the channel e.g. AlarmSystem. There are two types of tags -- namely "Semantic" and "Non Semantic". See [Default Tags](#default-tags) below.                             | mandatory                                     |
