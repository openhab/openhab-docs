...
| low-battery           | system.low-battery           | Switch                   | LowBattery       | Alam, LowBattery          | Represents a low battery warning with possible values on (low battery) and off (battery ok).                                                                                                                            |
