...
source: https://github.com/openhab/openhab-docs/blob/main/src/installation/linux.md
meta:
  - property: og:title
    content: "openHAB on Linux"
...
If you're new to openHAB, then you should checkout the [beginner's tutorial](/docs/tutorial/first_steps.html)!
...
With openHAB you can also [use the openHAB console](/docs/administration/logging.html#karaf-console) to have a colored glance at the logging information.
...
The [openHAB VS Code Extension](/docs/configuration/editors.html#openhab-vs-code-extension) software does also depend on a mounted share to access the openHAB configuration files.
