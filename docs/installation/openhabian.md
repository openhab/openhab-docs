...
-   Samba file sharing [pre-configured ready to use shares](/docs/installation/linux.html#mounting-locally)
...
See [Getting Started - First Steps](/docs/tutorial/first_steps.html) for what to do next with openHAB.
