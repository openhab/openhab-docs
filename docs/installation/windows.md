---
title: Windows
source: https://github.com/openhab/openhab-docs/blob/main/src/installation/windows.md
meta:
  - property: og:title
    content: "Windows"
...
Please be sure you have installed the required supporting applications as described in [Prerequisites](/docs/installation/index.html#prerequisites).
...
- Create a New System Variable named JAVA_HOME (or update the existing one) to match the installation directory of the Java Platform chosen and installed in the step [Prerequisites](/docs/installation/index.html#prerequisites).
...
- continue reading the [Additional steps](/docs/installation/index.md#additional-steps) section of the Installation overview
