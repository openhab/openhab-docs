...
source: https://github.com/openhab/openhab-docs/blob/main/src/installation/reverse-proxy.md
meta:
  - property: og:title
    content: "Running openHAB Behind a Reverse Proxy"
...
- A working installation of openHAB on your DiskStation (see the [Synology Installation Guide](/docs/installation/synology.html/))
