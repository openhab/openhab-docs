...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/blockly/rules-blockly-before-using.md
meta:
  - property: og:title
    content: "Rules Blockly - Before Using"
...
- To be able to conveniently view your log files it is recommended to setup _frontail_ which can be achieved easily via [openhabian-config](/docs/installation/openhabian.html#optional-components)
...
- **see [how to log](/docs/administration/logging.html)**
