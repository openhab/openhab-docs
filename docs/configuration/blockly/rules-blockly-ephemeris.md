...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/blockly/rules-blockly-ephemeris.md
meta:
  - property: og:title
    content: "Rules Blockly - Ephemeris"
...
See the [Ephemeris configuration page](/docs/configuration/actions.html#configuration) for more information.
