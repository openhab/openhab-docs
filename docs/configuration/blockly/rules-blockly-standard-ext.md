...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/blockly/rules-blockly-standard-ext.md
meta:
  - property: og:title
    content: "Rules Blockly - openHAB Extensions to the Standard"
