...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/blockly/rules-blockly-persistence.md
meta:
  - property: og:title
    content: "Rules Blockly - Persistence"
...
For more information on persistence, the default service, and its configuration see the [persistence documentation](/docs/configuration/persistence.html).
...
For more information, see: [Time-weighted calculations - Riemann Sums](/docs/configuration/persistence.html#time-weighted-calculations-riemann-sums)
