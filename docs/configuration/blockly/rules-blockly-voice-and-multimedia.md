...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/blockly/rules-blockly-voice-and-multimedia.md
meta:
  - property: og:title
    content: "Rules Blockly - Voice and Multimedia"
...
- Audio Sinks
  ...
  - [Reference on how to setup Audio and Audio Sinks](/docs/configuration/multimedia.html)
- Text-To-Speech
  - In order to use text-to-speech, you need to install at least one [TTS service](https://www.openhab.org/addons/#voice).
  - see [openHAB Voice](/docs/configuration/multimedia.html#voice) for more information
