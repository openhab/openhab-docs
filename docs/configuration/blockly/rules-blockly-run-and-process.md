...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/blockly/rules-blockly-run-and-process.md
meta:
  - property: og:title
    content: "Rules Blockly - Run & Process and Transformations"
...
See [openHAB Call-Script](/docs/configuration/actions.html#openhab-subsystem-actions) for background information
...
- For more detailed information see [UI Event Object](https://next.openhab.org/addons/automation/jsscripting/#ui-event-object) or [openHAB Events](/docs/developer/utils/events.html).
...
openHAB provides many [transformations](/docs/configuration/transformations.html):
