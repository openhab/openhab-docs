---
title: Editors
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/editors.md
meta:
  - property: og:title
    content: "Editors"
...
If you are using [openHABian](/docs/installation/openhabian.html), the network shares are readily configured for you, you only need to mount them locally.
