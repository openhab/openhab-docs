...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/transformations.md
meta:
  - property: og:title
...
1. Item and Sitemap Labels
    ...
    Transformations used in the [state/value part](/docs/configuration/items.html#state-transformation) of labels are applied **on the fly**.
    ...
    Usage of Transformations in the [label parameter of Sitemap elements](/docs/ui/sitemaps.html#element-type-text) works the same way.
...
1. Profiles
    ...
    See [profile documentation](/docs/configuration/items.html#profiles) for more details.
