---
title: Multimedia
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/multimedia.md
meta:
  - property: og:title
    content: "Multimedia"
...
Please refer to the [Main UI docs](/docs/mainui/about.html#web-audio-sink) for setting up web audio in Main UI.
...
Visit the [Blockly docs](/docs/configuration/blockly/rules-blockly-voice-and-multimedia.html) to learn how to use audio actions from Blockly.
...
You will find more examples in the documentation of the [Automation add-ons](/addons/#automation) and the [Blockly docs](/docs/configuration/blockly/rules-blockly-voice-and-multimedia.html).
...
Visit the [Blockly docs](/docs/configuration/blockly/rules-blockly-voice-and-multimedia.html) to learn how to use voice actions from Blockly.
