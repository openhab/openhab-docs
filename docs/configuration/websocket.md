...
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/websocket.md
meta:
  - property: og:title
    content: "openHAB WebSocket API"
...
The WebSocket API allows connecting to openHAB's dialog processor remotely, refer to [Voice Assistant](/docs/configuration/multimedia.html#voice-assistant) for setup.
