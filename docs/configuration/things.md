---
title: Things
source: https://github.com/openhab/openhab-docs/blob/main/src/configuration/things.md
meta:
  - property: og:title
    content: "Things"
...
[Things](/docs/concepts/things.html) represent the physical layer of an openHAB system.
...
These Channels can be linked to [items](/docs/concepts/items.html).
...
1. [Add Items](/docs/configuration/items.html) and link them to the Thing's Channels
1. At this point Items can be used to control the Thing or consume its information in e.g. [Sitemaps](/docs/ui/sitemaps.html) or [Rules](/docs/configuration/rules-dsl.html)

There are two methods for defining Things provided by the various bindings:
through [discovery](/docs/concepts/discovery.html) or by manual definition in configuration text files.
...
Things can be added to the system using [discovery](/docs/concepts/discovery.html), which allows Things to be discovered automatically if the appropriate binding has been installed and configured.
...
See the [beginner tutorial](/docs/tutorial/things_simple.html) for a step-by-step guide on how to configure Things using discovery.
...
For more details about Item definition and usage, please refer to the [Items configuration article](/docs/configuration/items.html).
