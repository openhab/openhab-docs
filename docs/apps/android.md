...
The app follows the basic principles of the other openHAB UIs, like Basic UI, and presents your predefined openHAB [sitemap(s)](/docs/configuration/sitemaps.html) and other UIs, like Main UI.
...
There are a number of strategies available to provide [secure remote access](/docs/installation/security.html) to your openHAB server.
...
* Receive notifications through an openHAB Cloud connection, [read more](/docs/configuration/actions.html#cloud-notification-actions)
...
When using a [semantic model](/docs/tutorial/model.html#semantic-model) the location and/or equipment name can be shown in the tiles.
