...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/tips-and-tricks.md
meta:
  - property: og:title
...
For more information about the search and which entities are searchable, please refer to the [Developer Sidebar docs](/docs/mainui/developer/sidebar.html#developer-sidebar-search).
