---
title:  Persistence
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/persistence.md
meta:
  - property: og:title
    content: " Persistence"
...
See the [Persistence docs](/docs/configuration/persistence.html) for full documentation, and see the installation page for the method you used to install openHAB for a table listing file locations.
