...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/index.md
meta:
  - property: og:title
    content: "Getting Started - Introduction"
...
This new user tutorial assumes that you have at least a basic understanding of the [concepts of openHAB](/docs/concepts/), and already have a working installation of openHAB.
...
You can review the reference documentation for details on the text based approach here </docs/configuration/>.
...
[First Steps](/docs/tutorial/first_steps.html): Initial configuration

[Adding Things: Simple](/docs/tutorial/things_simple.html): Discovering Things

[Adding Things: Intermediate](/docs/tutorial/things_intermediate.html): Creating Bridges

[Adding Things: Advanced](/docs/tutorial/things_advanced.html): Manual creation of Things

[Items and the Semantic Model](/docs/tutorial/model.html): Creating Items and Putting Them into a Semantic Model

[Persistence](/docs/tutorial/persistence.html): Saving and Retrieving Historic Data

[Intro to Pages](/docs/tutorial/pages_intro.html): Visualizing and Using the Home Automation

[Overview Page](/docs/tutorial/auto_overview.html): Automatically Generated Overview Page

[Item Widget Customization](/docs/tutorial/item_widgets.html): Customize How Items Appear in Cards

[Custom Item Widgets](/docs/tutorial/custom_widgets.html): Creating your own widgets

<!--
[Rules: Simple](/docs/tutorial/rules_simple.html): Introduction to rules and a simple example

[Rules: Intermediate](/docs/tutorial/rules_intermediate.html): Rules that involve some scripting

[openHAB Cloud](/docs/tutorial/cloud.html): Connecting to the free openHAB Cloud Service

[Putting it all Together](/docs/tutorial/example.html) Comprehensive Example
-->
