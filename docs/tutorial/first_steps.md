...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/first_steps.md
meta:
  - property: og:title
    content: "Getting Started - First Steps"
...
Currently the only way to add additional users or manage existing ones (including changing passwords and attributing roles) is with the [Console](/docs/administration/console.html).
