...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/things_simple.md
meta:
  - property: og:title
    content: " Adding Things - Simple"
...
As covered in the [concepts section](/docs/concepts/index.html) of the openHAB Docs, a binding is an add-on to openHAB that understands how to communicate with a specific home automation technology or API.
