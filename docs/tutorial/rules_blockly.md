---
title:  Rules - Blockly
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/rules_blockly.md
meta:
  - property: og:title
    content: " Rules - Blockly"
...
See the [**Blockly Reference**](/docs/configuration/blockly/index.html) for a detailed tutorial and reference for doing that.
...
For those who do better with video, there are a few videos introducing Blockly on the openHAB [Youtube feed](/docs/configuration/blockly/index.html#blockly-youtube-tutorials)
...
There are three options to choose from which are explained very well [here](/docs/configuration/rules-dsl.html#manipulating-item-states).
...
- Watch the logs for errors, your log statements, and relevant events  (see the [Blockly Reference](/docs/configuration/blockly/index.html) on how to easily access log information)
