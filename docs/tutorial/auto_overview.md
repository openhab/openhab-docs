...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/auto_overview.md
meta:
  - property: og:title
    content: "Pages - Overview Page"
...
If you've customized the chart and want to return to the same chart again, you can save it and a new [Chart Page](/docs/ui/chart-pages.html) will be created showing those Items with those settings.
...
[Expressions](/docs/ui/widget-expressions-variables.html) can be used to make the Title and Subtitle change based on the states of Items or other conditions.
...
See the [UI Docs](/docs/ui/index.html) for a detailed reference.
