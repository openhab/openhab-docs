...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/rules_advanced.md
meta:
  - property: og:title
...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| [Blockly](/docs/configuration/blockly/)         | See the previous page                                                                                                                                               | Non-developers          |
| [Rules DSL](/docs/configuration/rules-dsl.html) | A programming language developed specifically for openHAB based on [Xbase](https://eclipse.dev/Xtext/documentation/305_xbase.html#xbase-language-ref-introduction). | Long time openHAB users |
