...
source: https://github.com/openhab/openhab-docs/blob/main/src/tutorial/custom_widgets.md
meta:
  - property: og:title
    content: " Pages - Custom Widgets"
...
For a comprehensive reference on creating widgets, please see the [Building Pages](/docs/ui/building-pages.html) guide in the docs.
...
For this, the [oh-repeater](/docs/ui/components/oh-repeater.html) component is very useful.
...
See the [Layout Pages docs](/docs/ui/layout-pages.html) for details.
...
[Chart pages](/docs/ui/chart-pages.html), [Floorplan pages](/docs/ui/floorplan-pages.html), [Map pages](/docs/ui/map-pages.html), and [Tabbed pages](/docs/ui/tabbed-pages.html) are also available.
