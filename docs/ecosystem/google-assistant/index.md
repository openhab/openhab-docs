...
To expose [items](/docs/concepts/items.html) to Google Assistent you will need to add [metadata](/docs/concepts/items.html#item-metadata) in the `ga` namespace.
...
- The items that you want to expose to Google Assistant must have a item label! [Item Definition and Syntax](/docs/configuration/items.html#item-definition-and-syntax)
