---
title: Map Pages
source: https://github.com/openhab/openhab-docs/blob/main/src/ui/map-pages.md
meta:
  - property: og:title
    content: "Map Pages"
...
To add markers, under Markers, click either **Add marker** or **Add circle marker** as necessary.
Then click on the newly added entry to configure the marker.
