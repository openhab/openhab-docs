...
source: https://github.com/openhab/openhab-docs/blob/main/src/ui/building-pages.md
meta:
  - property: og:title
    content: "Building Pages - Components & Widgets"
...
- a **props** structure describing its own properties; props define parameters and parameter groups following a subset of the configuration description schema found in bindings, services and throughout openHAB: see [Configuration Descriptions](/docs/developer/addons/config-xml.html)
- a set of **tags**
