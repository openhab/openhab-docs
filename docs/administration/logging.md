---
title: Logging
source: https://github.com/openhab/openhab-docs/blob/main/src/administration/logging.md
meta:
  - property: og:title
    content: "Logging"
...
Administrator users can view the logs directly in Main UI through [Developer Tools - Log Viewer](/docs/mainui/developer/log-viewer.html).
