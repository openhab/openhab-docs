...
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/settings/transformations.md
meta:
  - property: og:title
    content: "Settings - Transformations"
...
To learn more about transformations, read the [transformation docs](/docs/configuration/transformations.html).
