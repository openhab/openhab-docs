...
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/settings/model.md
meta:
  - property: og:title
...
Learn more about the semantic model in [the tutorial](/docs/tutorial/model.html).
