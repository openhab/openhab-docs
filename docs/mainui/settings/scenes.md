...
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/settings/scenes.md
meta:
  - property: og:title
    content: "Settings - Scenes"
...
A comprehensive introduction to scenes can be found at the [scenes tutorial](/docs/tutorial/rules_scenes.html).
