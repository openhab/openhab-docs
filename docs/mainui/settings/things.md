...
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/settings/things.md
meta:
  - property: og:title
    content: "Settings - Things"
...
Please read [the tutorial](/docs/tutorial/things_simple.html#accept-the-light-bulb-things) to learn how to use the inbox.
