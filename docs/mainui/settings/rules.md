...
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/settings/rules.md
meta:
  - property: og:title
...
There is a [rules concepts page](/docs/concepts/rules.html) that explains the idea of rules in detail, and a comprehensive introduction to rules in the [rules tutorial](/docs/tutorial/rules_basic.html).
...
To add a rule press the plus icon ![add rule](../images/plus.png) in the lower right corner and follow the [rules tutorial](/docs/tutorial/rules_basic.html#create-the-rule).
