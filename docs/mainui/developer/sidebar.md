...
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/developer/sidebar.md
meta:
  - property: og:title
    content: "Developer Tools - Developer Sidebar"
...
The developer sidebar is split into a "**Tools**" section with several useful tools including a [universal search](/docs/mainui/developer/sidebar.html#developer-sidebar-search), a widget expression tester,
