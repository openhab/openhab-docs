---
title: Chat
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/chat.md
meta:
  - property: og:title
    content: "Chat"
...
It requires a [LLM-based human language interpreter](/docs/configuration/multimedia.html#llm-based-interpreters) to be configured as the default interpreter.
...
1. **Compatible Interpreter**: You need a [LLM-based HLI service](/docs/configuration/multimedia.html#llm-based-interpreters), such as [Google Gemini](/addons/bindings/gemini/).
