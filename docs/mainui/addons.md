---
title: Add-on Store
source: https://github.com/openhab/openhab-docs/blob/main/src/mainui/addons.md
meta:
  - property: og:title
    content: "Add-on Store"
...
To learn more how to install add-ons read the [Add-ons tutorial](/docs/configuration/addons).
...
- **Block Libraries**: Community extensions to the [Blockly](/docs/configuration/blockly/) toolbox.<br>
