...
type: persistence
description: '"This service allows you to persist and query states using the [InfluxDB](https://www.influxdata.com/products/influxdb-overview/)
  and [InfluxDB 2.0](https://v2.docs.influxdata.com/v2.0/) time series database. The
  persisted values can be queried from within openHAB."'
...
meta:
  ...
  - property: og:description
    content: '"This service allows you to persist and query states using the InfluxDB
---
...
Please consider [persistence documentation](/docs/configuration/persistence.html#persistence) for further information.
