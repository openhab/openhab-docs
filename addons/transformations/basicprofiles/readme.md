...
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.transform.basicprofiles/README.md
meta:
  - property: og:title
...
| Configuration Parameter | Type    | Description                                                                                                                                                                                                              |
|-------------------------|---------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `timeout`               | text    | Duration after which the Item's state is updated if no data is received from the binding. The default is 1h. The format is the same as used in the [expire parameter](/docs/configuration/items). |
...
| Configuration Parameter | Type    | Description                                                                                                                                         |
|-------------------------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| `duration`              | text    | Duration of the time frame to collect state updates. See [format examples](/docs/configuration/items.html#parameter-expire). |
