...
type: voice
description: '"Google Cloud STT Service uses the non-free Google Cloud Speech-to-Text
  API to transcript audio data to text."'
...
meta:
  ...
  - property: og:description
    content: '"Google Cloud STT Service uses the non-free Google Cloud Speech-to-Text
---
