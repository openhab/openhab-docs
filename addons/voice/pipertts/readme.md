...
type: voice
description: '"This voice service allows you to use [Piper](https://github.com/OHF-Voice/piper1-gpl)
  as your TTS service in openHAB."'
...
meta:
  ...
  - property: og:description
    content: '"This voice service allows you to use Piper
---
