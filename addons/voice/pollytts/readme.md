...
type: voice
description: '"PollyTTS is a voice service utilizing the Internet based text-to-speech
  (TTS) service [Amazon Polly](https://aws.amazon.com/polly/)."'
...
meta:
  ...
  - property: og:description
    content: '"PollyTTS is a voice service utilizing the Internet based text-to-speech
---
