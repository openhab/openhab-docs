...
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.uis.habot/README.md
meta:
  - property: og:title
    content: "HABot - UIs"
...
- an openHAB [Human Language Interpreter](/docs/configuration/multimedia.html#human-language-interpreter) - this means once the natural language answers expand to more than "here's what I found" and "there you go", you will eventually be able to ask HABot questions and give it orders without a visual UI when coupled with speech-to-text and text-to-speech engines in openHAB, for instance to build privacy-focused specialized voice assistant.
