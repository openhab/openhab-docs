...
| Error     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|-----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `S:0` or `C:0` | When in [Wi-Fi mode](#wi-fi)
, this error occurs if a sitemap request or command fails because the server is not reachable, for example due to an incorrect URL in the configuration. |
