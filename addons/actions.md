...
For example you could run `var ScriptResponse = executeCommandLine(Duration.fromSeconds(60), "path/to/my/script.sh");` would get executed and wait 1 minute for the output to be responded back and write it into the `ScriptResponse` variable.
...
var ScriptResponse = executeCommandLine(Duration.fromSeconds(60), "path/to/my/script.sh", itemState1, itemState2);
```
