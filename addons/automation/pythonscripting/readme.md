...
Use the [console logging](/docs/administration/logging.html) commands to
...
The [openHAB Console](/docs/administration/console.html) provides access to additional features of these Add-on.
...
1. Login into [openHAB console](/docs/administration/console.html) and check your current pythonscripting environment by calling `pythonscripting info`<br/><br/>Important values are:
...
Before you can enable autocompletion, you must generate the required type hint stub files. Login into [openHAB console](/docs/administration/console.html) and run
