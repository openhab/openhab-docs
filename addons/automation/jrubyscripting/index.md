...
install: manual
source: https://github.com/openhab/openhab-jruby/blob/main/USAGE.md
meta:
  - property: og:title
...
- Go to `Settings -> Add-ons -> Automation` and install the jrubyscripting automation addon following the [openHAB instructions](/docs/configuration/addons.html).
...
A [Timed Command](https://openhab.github.io/openhab-jruby/main/OpenHAB/DSL/Items/TimedCommand.html) is similar to the openHAB Item's [expire parameter](/docs/configuration/items.html#parameter-expire) but it offers more flexibility.
...
[openHAB built-in actions](/docs/configuration/actions.html) are available as children of the [Actions](https://openhab.github.io/openhab-jruby/main/OpenHAB/Core/Actions.html) module.
...
The [within?](https://openhab.github.io/openhab-jruby/main/OpenHAB/CoreExt/TimePredicates.html#within%3F-instance_method) method allows you to check if a date/time object is within a specific distance (epsilon) of an anchor time. By default, this anchor time is `now`.
...
[Helper methods](https://openhab.github.io/openhab-jruby/main/OpenHAB/CoreExt/Ephemeris.html) to easily access [openHAB's Ephemeris action](/docs/configuration/actions.html#ephemeris) are provided on all date-like objects:
...
This add-on also provides the necessary infrastructure to use Ruby for writing [transformations](/docs/configuration/transformations.html).
...
Sitemaps can be created via [sitemaps.build](https://openhab.github.io/openhab-jruby/main/OpenHAB/Core/Sitemaps/Registry.html#build-instance_method).
