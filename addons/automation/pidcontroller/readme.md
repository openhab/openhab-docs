...
The PID controller can be used in openHAB's [rule engine](/docs/configuration/rules-dsl.html).
...
|------------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| `input`          | Item    | Name of the input [Item](/docs/configuration/items.html) (e.g. temperature sensor value)                                    | Y        |
...
After you added a [Rule](/docs/configuration/rules-dsl.html) with above trigger and action module and configured those, proceed with the following steps:
...
[Persistence](/docs/configuration/persistence.html) for more details and instructions.
