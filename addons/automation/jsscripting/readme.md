...
type: automation
description: This add-on provides support for JavaScript (ECMAScript 2025+) that can be used as a scripting language within automation rules.
logo: images/addons/jsscripting.svg
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.automation.jsscripting/README.md
meta:
  - property: og:title
    content: "JavaScript Scripting - Automation"
  - property: og:description
    content: This add-on provides support for JavaScript (ECMAScript 2025+) that can be used as a scripting language within automation rules.
---
...
To learn more about the structure of the event source, refer to the [Event Bus](/docs/developer/utils/events.html#the-core-events) documentation.
...
Script logging is enabled by default at the `INFO` level (messages from `console.debug` and `console.trace` won't be displayed), but can be configured using the [openHAB console](/docs/administration/console.html), e.g.:
...
See the [transformation docs](/docs/configuration/transformations.html#script-transformation) for more general information on the usage of script transformations.
...
Additional information can be found on the [Ephemeris Actions Docs](/docs/configuration/actions.html#ephemeris) as well as the [Ephemeris Javadoc](https://www.openhab.org/javadoc/latest/org/openhab/core/model/script/actions/ephemeris).
...
A Quantity consists of a measurement and its [Unit of Measurement (UoM)](/docs/concepts/units-of-measurement.html#list-of-units), e.g. `5.7 m` (the measurement is `5.7`, the unit is `m` meters).
...
Nearly all [Units of Measurement (UoM)](/docs/concepts/units-of-measurement.html#list-of-units) are expected to work with `Quantity`.
...
A list of available utilities and types can be found in the [JSR223 Default Preset documentation](/docs/configuration/jsr223.html#default-preset-importpreset-not-required).
