...
type: transform
description: '"The Rollershutter Position emulates an absolute position setting for
  Rollershutter devices which only support basic UP/DOWN/STOP commands."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"The Rollershutter Position emulates an absolute position setting for
---
