...
type: transform
description: '"Transforms an [XML](https://www.w3.org/XML/) input using an [XPath](https://www.w3.org/TR/xpath/#section-Expressions)
  expression."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"Transforms an XML input using an XPath(https://www.w3.org/TR/xpath/#section-Expressions)
---
