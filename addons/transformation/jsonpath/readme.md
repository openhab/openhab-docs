...
type: transform
description: '"Extracts values from a JSON string using a [JsonPath](https://github.com/jayway/JsonPath#jayway-jsonpath)
  expression."'
logo: images/addons/jsonpath.png
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.transformation.jsonpath/README.md
meta:
  - property: og:title
    content: "JsonPath - Transformation Services"
  - property: og:description
    content: '"Extracts values from a JSON string using a JsonPath(https://github.com/jayway/JsonPath#jayway-jsonpath)
---
...
Now the resulting Number can also be used in the label to [change the color](/docs/configuration/sitemaps.html#label-and-value-colors) or in a rule as a value to compare.
