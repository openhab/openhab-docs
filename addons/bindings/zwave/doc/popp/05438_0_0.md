...
![05438 product image](https://opensmarthouse.org/zwavedatabase/230/image/)


The 05438 supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data between other devices in the mesh network.
...
 Inclusion and Exclusion are confirmed by a triple click of the button
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/230/reference/Manual-IP44-POPP-En.pdf)
* [Manual Popp Wall Plug Indoor](https://opensmarthouse.org/zwavedatabase/230/reference/Manual-IP20-POPP-En.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/230).
