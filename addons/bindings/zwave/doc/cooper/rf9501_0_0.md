...
![RF9501 product image](https://opensmarthouse.org/zwavedatabase/18/image/)
...
* [Specification Sheet](https://opensmarthouse.org/zwavedatabase/18/reference/AspireRFSwitchSpecSheet.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/18).
