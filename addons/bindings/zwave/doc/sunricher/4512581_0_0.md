...
This describes the Z-Wave device *Heatit Z-Push Button 8*, manufactured by *[Sunricher](www.sunricher.com)* with the thing type UID of ```sunricher_4512581_00_000```.
