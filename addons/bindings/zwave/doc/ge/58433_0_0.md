...
The following table provides a summary of the 9 configuration parameters available in the Enbrighten ZWA4011, 58433.
Detailed information on each parameter can be found in the sections below.

| Param | Name  | Description |
|-------|-------|-------------|
| 3 | LED | LED Indicator |
| 4 | Inverted | Inverted Orientation |
| 5 | 3-Way Setup | 3-Way Setup |
| 19 | Alternate Exclusion | Press two times ON and two times OFF, LED will flash 5 times if successful |
...
| 39 | Control Groups 2 & 3 | Control Groups 2 & 3 |
...
Press two times ON and two times OFF, LED will flash 5 times if successful
0 Disable
...
### Parameter 39: Control Groups 2 & 3
...
1 EnableThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
Values in the range 0 to 1 may be set.
...
The Enbrighten ZWA4011, 58433 supports 3 association groups.
...
Single Press
Add nodes that react to a single press
...
Double Press
Add nodes to react to double press
