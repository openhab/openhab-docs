...
![PST02-1B product image](https://opensmarthouse.org/zwavedatabase/534/image/)
...
* [German Manual (with configuration)](https://opensmarthouse.org/zwavedatabase/534/reference/Handbuch-Home-Control-Bewegungsmelder.pdf)
* [english manual (without configuration)](https://opensmarthouse.org/zwavedatabase/534/reference/Manual-devolo-Home-Control-Motion-Sensor-com.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/534).
