...
![AN179 product image](https://opensmarthouse.org/zwavedatabase/28/image/)


The AN179 supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data between other devices in the mesh network.
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/28/reference/Manual-AN179-20140808.pdf)
* [Everspring an179 Manual](https://opensmarthouse.org/zwavedatabase/28/reference/everspring---an179---manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/28).
