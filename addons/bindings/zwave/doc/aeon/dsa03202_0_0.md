...
* [Engineering Specification](https://opensmarthouse.org/zwavedatabase/74/reference/Aeon-Labs-Minimote---Engineering-Spec.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/74).
