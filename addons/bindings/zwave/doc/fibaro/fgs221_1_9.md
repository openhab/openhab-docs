...
This version of the device is limited to firmware versions 1.9 to 1.11

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGS221 product image](https://opensmarthouse.org/zwavedatabase/122/image/)
...
| 7 | Control key #2 behaviour | Map status to devices in group 2. |
...
| 15 | Dimmer/Roller shutter control | Enable/Disable operation of dimmer associated to group 1. |
...
| Value  | Description |
|--------|-------------|
| 0 | Map status to devices in group 1 |
| 1 | Map OFF status to group 1-last state |
| 2 | Map OFF status to group 1-full brightness |

The manufacturer defined default value is ```0``` (Map status to devices in group 1).
...
Map status to devices in group 2.
Commands are sent when device is turned off. Enabling device does not send control commands. Double-clicking key sends 'turn on' command, dimmers memorize the last saved state (e.g. 50% brightness).
The following option values may be configured -:
...
Enable/Disable operation of dimmer associated to group 1.
...
* [FGS221 Manual](https://opensmarthouse.org/zwavedatabase/122/reference/FGS221-Relay-Switch-2x1-5kW-en-1-4-1-7.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/122).
