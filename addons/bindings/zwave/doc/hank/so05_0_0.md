...
| 171 | Power Report Frequency | The interval of sending power report to association device. |
| 172 | Energy Report Frequency | The interval of sending energy report to association device. |
...
* [Smart Plug Manual V1.0](https://opensmarthouse.org/zwavedatabase/487/reference/SmartPlug.pdf)
