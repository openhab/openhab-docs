...
This describes the Z-Wave device *NZW37*, manufactured by *NIE Technology* with the thing type UID of ```nietech_nzw37_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![NZW37 product image](https://opensmarthouse.org/zwavedatabase/625/image/)
...
* [NZW37 Step by Step](https://opensmarthouse.org/zwavedatabase/625/reference/Step-by-Step-Instructions.pdf)
* [NZW37 Step by Step General](https://opensmarthouse.org/zwavedatabase/625/reference/Step-by-Step-Instructions-General-Z-Wave.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/625).
