...
# MS10Z Wall Switch
This describes the Z-Wave device *MS10Z*, manufactured by *NIE Technology* with the thing type UID of ```nietech_ms10z_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![MS10Z product image](https://opensmarthouse.org/zwavedatabase/1289/image/)


The MS10Z supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data between other devices in the mesh network.
...
The following table summarises the channels available for the MS10Z -:
...
The following table provides a summary of the 4 configuration parameters available in the MS10Z.
...
The MS10Z supports 2 association groups.
