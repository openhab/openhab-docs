...
The following table provides a summary of the 9 configuration parameters available in the PAB04.
...
| 7 | Remember  Last Switch  State mode |  |
| 8 | Water Flow Sample Interval | 1:1S 2:10S 3:30S 4:60S |
| 9 | Accumulated  Water Flow value | 0-999999 |
...
### Parameter 7: Remember  Last Switch  State mode
...
### Parameter 8: Water Flow Sample Interval

1:1S 2:10S 3:30S 4:60S
...
The manufacturer defined default value is ```1``` (1s).

This parameter has the configuration ID ```config_8_1``` and is of type ```INTEGER```.


### Parameter 9: Accumulated  Water Flow value

0-999999
0.1 Gallon or 0.1 KL
