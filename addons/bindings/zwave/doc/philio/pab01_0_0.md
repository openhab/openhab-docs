...
* [User manual](https://opensmarthouse.org/zwavedatabase/560/reference/ph-pab01-Zipato-Micromodule-Energy-Meter-User-Manual-v1-0.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/560).
