...
![WT00Z-1 product image](https://opensmarthouse.org/zwavedatabase/13/image/)
...
| 7 | dim step parameter | dim step parameter valid values: 1-99 |
| 8 | dim timer parameter | dim timer parameter valid values: 1-255 |
| 9 | Local control dim step  | dim step parameter valid values: 1-99 |
| 10 | Local control dim timer  | dim timer parameter valid values: 1-255 |
| 11 | ALL ON/ ALL OFF dim step  | dim step parameter valid values: 1-99 |
| 12 | ALL ON/ ALL OFF dim timer | dim timer parameter valid values: 1-255 |
...
### Parameter 7: dim step parameter
...
### Parameter 8: dim timer parameter
...
### Parameter 10: Local control dim timer 
...
### Parameter 12: ALL ON/ ALL OFF dim timer
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/13/reference/linear-satellite-radio-wt00z-1-users-manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/13).
