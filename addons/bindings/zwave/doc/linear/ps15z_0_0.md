...
![PS15Z product image](https://opensmarthouse.org/zwavedatabase/352/image/)
...
No device information is provided in the database. Consider [updating the database](https://opensmarthouse.org/zwavedatabase/352) to improve the documentation.
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/352/reference/linear-ps15z2-instruction-manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/352).
