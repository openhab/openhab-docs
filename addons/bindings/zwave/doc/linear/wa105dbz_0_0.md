...
![WA105DBZ product image](https://opensmarthouse.org/zwavedatabase/365/image/)
...
No device information is provided in the database. Consider [updating the database](https://opensmarthouse.org/zwavedatabase/365) to improve the documentation.
...
* [Installation Instructions](https://opensmarthouse.org/zwavedatabase/365/reference/WA105DBZ-install.pdf)
* [GoControl version instruction scan](https://opensmarthouse.org/zwavedatabase/365/reference/GoControl-Siren.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/365).
