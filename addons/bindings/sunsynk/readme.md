...
After installation, to gain further information on any issues you encounter you can turn on Debug [Logging](/docs/administration/logging.html) either through the [karaf console](/docs/administration/console.html) or through the openHAB UI.
