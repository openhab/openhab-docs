...
type: io
description: '"YAML Composer introduces extended YAML features that make openHAB configuration
  more modular, reusable, and maintainable. These features let you structure configuration
  as composable building blocks rather than large, repetitive files."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"YAML Composer introduces extended YAML features that make openHAB configuration
---
