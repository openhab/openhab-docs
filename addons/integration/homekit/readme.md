...
type: io
description: '"This is an add-on that exposes your openHAB system as a bridge over
...
meta:
  ...
  - property: og:description
    content: '"This is an add-on that exposes your openHAB system as a bridge over
---
...
After setting the global configuration, you will need to tag your [openHAB items](/docs/configuration/items.html) for HomeKit with an accessory type.
...
The mapping between openHAB items and HomeKit accessory and characteristics is done by means of [metadata](/docs/concepts/items.html#item-metadata).
...
To do this, you can issue the command `openhab:homekit clearPairings` from the [OSGi console](/docs/administration/console.html).
...
In order to get logs from the underlying library used to implement the HomeKit protocol, enable trace logging using the following commands at [the console](/docs/administration/console.html):
...
- In [openhab-cli](/docs/administration/console.html), run `openhab:homekit clearPairings`.
  Try again.
...
1. If you have `useDummyAccessories` enabled, open the
   [openhab-cli](/docs/administration/console.html).
