...
type: io
description: '"Hue Emulation exposes openHAB items as Philips Hue lights to Hue API-compatible
  applications like Amazon Echos, Google Homes, or any other Hue-compatible application."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"Hue Emulation exposes openHAB items as Philips Hue lights to Hue API-compatible
---
