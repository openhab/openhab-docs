...
type: io
description: '"The openHAB Cloud Connector allows connecting the local openHAB runtime
  to a remote [openHAB Cloud](https://github.com/openhab/openhab-cloud/blob/master/README.md)
  instance, such as [myopenHAB.org](https://www.myopenHAB.org), which is an instance
  of the"'
logo: images/addons/openhabcloud.png
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.integration.openhabcloud/README.md
meta:
  - property: og:title
    content: "openHAB Cloud Connector - System Integrations"
  - property: og:description
    content: '"The openHAB Cloud Connector allows connecting the local openHAB runtime
---
...
- `icon`: String containing the icon name (as described in [Items: Icons](/docs/configuration/items.html#icons)).
...
- `ui`: Controls the UI in two possible ways:
  ...
  - `ui:$commandItemSyntax` where `$commandItemSyntax` is the same syntax as used for the [UI Command Item](/docs/mainui/about.html#ui-command-item).
