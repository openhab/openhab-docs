...
id: opentelemetry
label: OpenTelemetry
title: OpenTelemetry - System Integrations
type: io
description: The OpenTelemetry service integrates openHAB with the [OpenTelemetry](https://opentelemetry.io/) observability framework.
logo: images/addons/opentelemetry.svg
install: manual
children:
- - doc/lgtm-stack
  - LGTM Stack Example
...
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.integration.opentelemetry/README.md
meta:
  - property: og:title
    content: "OpenTelemetry - System Integrations"
  - property: og:description
    content: The OpenTelemetry service integrates openHAB with the OpenTelemetry observability framework.
---
