...
type: binding
description: '"Insteon is a proprietary home automation system that enables light
  switches, lights, thermostats, leak sensors, remote controls, motion sensors, and
  other electrically powered devices to interoperate through power lines, radio frequency
  (RF) communications, or both (dual-band)"'
...
meta:
  ...
  - property: og:description
    content: '"Insteon is a proprietary home automation system that enables light
---
...
See [logging in openHAB](/docs/administration/logging.html) for more info.
