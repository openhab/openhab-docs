...
title: DALI - Bindings
type: binding
description: '"This binding supports controlling devices on a DALI bus (Digital Addressable
  Lighting Interface) via a [daliserver](https://github.com/onitake/daliserver) connection."'
...
meta:
  ...
  - property: og:description
    content: '"This binding supports controlling devices on a DALI bus (Digital Addressable
---
