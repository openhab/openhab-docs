...
type: binding
description: '"The ZWave binding supports an interface to a wireless Z-Wave home automation
  network."'
...
meta:
  ...
  - property: og:description
    content: '"The ZWave binding supports an interface to a wireless Z-Wave home automation
---
...
To enable debug logging, log on to the [console](/docs/administration/console.html) and enter the following command -:
