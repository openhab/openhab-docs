...
type: binding
description: '"This binding uses the [AirParif service](https://www.airparif.fr/)
  for providing air quality information for Paris and departments of the Ile-de-France."'
...
meta:
  ...
  - property: og:description
    content: '"This binding uses the AirParif service
---
