...
type: binding
description: The SolarEdge binding retrieves live data from SolarEdge sites via the central web API.
...
meta:
  ...
  - property: og:description
    content: The SolarEdge binding retrieves live data from SolarEdge sites via the central web API.
---
