...
type: binding
description: '"This binding uses the [Atmo France service](https://www.atmo-france.org/)
  for providing air quality and pollens information in France."'
...
meta:
  ...
  - property: og:description
    content: '"This binding uses the Atmo France service
---
