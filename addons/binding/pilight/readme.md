...
type: binding
description: '"The pilight binding allows openHAB to communicate with a [pilight](https://www.pilight.org/)
  instance running pilight version 6.0 or greater."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"The pilight binding allows openHAB to communicate with a pilight
---
