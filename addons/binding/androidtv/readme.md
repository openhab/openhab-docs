...
type: binding
description: '"This binding is designed to emulate different protocols to interact
  with the AndroidTV platform."'
...
meta:
  ...
  - property: og:description
    content: '"This binding is designed to emulate different protocols to interact
---
