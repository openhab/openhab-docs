...
type: binding
description: '"This binding is for the Liquid-Check device from SI-Elektronik GmbH
...
meta:
  ...
  - property: og:description
    content: '"This binding is for the Liquid-Check device from SI-Elektronik GmbH
---
