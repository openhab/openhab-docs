...
type: binding
description: '"The binding allows control of Anthem AV processors over an IP connection
  to the processor."'
...
meta:
  ...
  - property: og:description
    content: '"The binding allows control of Anthem AV processors over an IP connection
---
