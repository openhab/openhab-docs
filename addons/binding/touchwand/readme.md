...
type: binding
description: '"TouchWand Wanderfull™ Hub basic is a plug & play Z-Wave based controller
  that uses Wi-Fi and Bluetooth to easily connect all smart home components."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"TouchWand Wanderfull™ Hub basic is a plug & play Z-Wave based controller
---
