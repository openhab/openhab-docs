...
type: binding
description: '"The [Leap Motion](https://www.leapmotion.com/) controller is a gesture
  sensoring device that uses stereoscopic cameras and is connected through USB."'
logo: images/addons/leapmotion.png
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.leapmotion/README.md
meta:
  - property: og:title
    content: "Leap Motion - Bindings"
  - property: og:description
    content: '"The Leap Motion controller is a gesture
---
