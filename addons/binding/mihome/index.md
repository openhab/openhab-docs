...
- Login to the [openHAB Console](/docs/administration/console.html)
...
- Enter ```log:tail``` in the console or exit the console and start [viewing the logs](/docs/tutorial/logs.html)
