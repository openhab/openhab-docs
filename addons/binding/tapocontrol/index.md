...
type: binding
description: This binding adds support to control Tapo (Copyright © TP-Link Corporation Limited) Smart Home devices and for IP cameras from your local openHAB system.
...
meta:
  ...
  - property: og:description
    content: This binding adds support to control Tapo (Copyright © TP-Link Corporation Limited) Smart Home devices and for IP cameras from your local openHAB system.
---
