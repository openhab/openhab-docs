...
- [MQTT Awtrix 3 Binding](../mqtt.awtrixlight/)
- [EspMilightHub Binding](../mqtt.espmilighthub/)
- [FPP Binding](../mqtt.fpp/)
- [Ruuvi Gateway MQTT Binding](../mqtt.ruuvigateway/)
...
- **unit**: Unit of measurement (optional). For supported units see [OpenHAB: List of Units](/docs/concepts/units-of-measurement.html#list-of-units). Examples: "°C", "°F"
