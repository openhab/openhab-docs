...
type: binding
description: '"The GROHE ONDUS Binding provides access to data collected by a GROHE
  ONDUS appliance, such as a [GROHE Sense Guard](https://www.grohe.de/de_de/smarthome/grohe-sense-guard/)."'
...
meta:
  ...
  - property: og:description
    content: '"The GROHE ONDUS Binding provides access to data collected by a GROHE
---
