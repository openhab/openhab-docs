...
type: binding
description: '"Many personal weather stations or similar devices are only capable
  of submitting measurements to the wunderground.com update site."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"Many personal weather stations or similar devices are only capable
---
