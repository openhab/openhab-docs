...
type: binding
description: '"This binding integrates large number of sensors and actuators from
  several different manufactures through [RFXCOM transceivers](http://www.rfxcom.com)."'
...
meta:
  ...
  - property: og:description
    content: '"This binding integrates large number of sensors and actuators from
---
