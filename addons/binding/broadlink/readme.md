...
type: binding
description: '"This binding supports sending infrared (IR) and radio frequency (RF)
  commands using a range of devices for made by (and occasionally OEM licensed from)
  [Broadlink](https://www.ibroadlink.com/)."'
...
meta:
  ...
  - property: og:description
    content: '"This binding supports sending infrared (IR) and radio frequency (RF)
---
