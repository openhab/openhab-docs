...
type: binding
description: '"The WebThing binding supports an interface to smart home device supporting
  the Web Thing API."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"The WebThing binding supports an interface to smart home device supporting
---
