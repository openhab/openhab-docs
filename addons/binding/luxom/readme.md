...
type: binding
description: '"This binding integrates with a <https://luxom.io/> based system through
  a Luxom IP interface module."'
...
meta:
  ...
  - property: og:description
    content: '"This binding integrates with a <https://luxom.io/> based system through
---
