...
type: binding
description: '"This extension adds support for [Ruuvi Tag](https://ruuvi.com/) and
  [Ruuvi Air](https://ruuvi.com/) sensor beacons."'
...
meta:
  ...
  - property: og:description
    content: '"This extension adds support for Ruuvi Tag and
---
