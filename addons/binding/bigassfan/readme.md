...
type: binding
description: '"The [BigAssFan](https://www.bigassfans.com/) binding is used to enable
  communication between openHAB and Big Ass Fans'' Haiku family of residential fans
  and lights that implement the SenseME technology."'
...
meta:
  ...
  - property: og:description
    content: '"The BigAssFan binding is used to enable
---
