...
type: binding
description: '"The Deutsche Bahn Binding provides the latest timetable information
  for all trains that arrive or depart at a specific train station, including live
  information for delays and changes in timetable."'
...
meta:
  ...
  - property: og:description
    content: '"The Deutsche Bahn Binding provides the latest timetable information
---
