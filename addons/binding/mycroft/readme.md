...
type: binding
description: '"This binding connects to Mycroft A.I. in order to control it or react
  to events by listening on the message bus."'
...
meta:
  ...
  - property: og:description
    content: '"This binding connects to Mycroft A.I. in order to control it or react
---
