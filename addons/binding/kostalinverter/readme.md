...
type: binding
description: '"Scrapes the web interface of the inverter for the metrics of the supported
  channels below."'
...
meta:
  ...
  - property: og:description
    content: '"Scrapes the web interface of the inverter for the metrics of the supported
---
