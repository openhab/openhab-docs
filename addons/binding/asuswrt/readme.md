...
type: binding
description: '"This binding adds support to read information from ASUS-Routers (Copyright
  © ASUS)."'
...
meta:
  ...
  - property: og:description
    content: '"This binding adds support to read information from ASUS-Routers (Copyright
---
