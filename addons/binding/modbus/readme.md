...
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.modbus/README.md
meta:
  - property: og:title
    content: "Modbus - Bindings"
  - property: og:description
    content: "This binding supports generic Modbus TCP and serial slave devices."
---
...
- [Kermi Heat pump](../modbus.kermi/)
- [Lambda Heat Pump](../modbus.lambda/)
- [Modbus Saia Burgess Controls Binding](../modbus.sbc/)
- [Stiebel Eltron ISG](../modbus.stiebeleltron/)
- [Studer](../modbus.studer/)
- [Modbus Sungrow Binding](../modbus.sungrow/)
...
Main documentation on `autoupdate` in [Items section of openHAB docs](/docs/configuration/items.html#item-definition-and-syntax).
...
Consult [background documentation on items](/docs/concepts/items.html) to understand accepted data types (state) by each item.
...
Consult [openHAB logging documentation](/docs/administration/logging.html#defining-what-to-log) for more information.
