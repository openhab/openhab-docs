...
title: IPP - Bindings
type: binding
description: '"This binding integrates printers, which implement the Internet Printing
  protocol (IPP). This is the successor of the CUPS binding."'
...
meta:
  ...
  - property: og:description
    content: '"This binding integrates printers, which implement the Internet Printing
---
