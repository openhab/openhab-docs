...
type: binding
description: '"This binding makes use of the CAN over Ethernet feature of the C.M.I.
  from Technische Alternative."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"This binding makes use of the CAN over Ethernet feature of the C.M.I.
---
...
Additionally you could use [openHAB's persistence service](/docs/configuration/persistence.html#restoring-item-states-on-restart) and its option to [restore the item states](/docs/configuration/persistence.html#restoring-item-states-on-restart) during openHAB startup.
