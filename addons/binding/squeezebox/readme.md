...
type: binding
description: '"This binding integrates the [Logitech Media Server](https://www.mysqueezebox.com)
  and compatible Squeeze players."'
...
meta:
  ...
  - property: og:description
    content: '"This binding integrates the Logitech Media Server
---
...
Please follow the [openHAB multimedia documentation](/docs/configuration/multimedia.html) for setup guidance.
