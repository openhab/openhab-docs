...
type: binding
description: '"The ''Deutsche Wetterdienst'' (DWD) reports the current pollen count
  index for Germany on a daily base and a forecast for tomorrow and the day after
  tomorrow."'
...
meta:
  ...
  - property: og:description
    content: '"The ''Deutsche Wetterdienst'' (DWD) reports the current pollen count
---
