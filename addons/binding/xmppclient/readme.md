...
type: binding
description: '"The XMPPClient binding provides support for sending and receiving XMPP
  (Jabber) messages."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"The XMPPClient binding provides support for sending and receiving XMPP
---
