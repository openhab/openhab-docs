...
|                 |                                                     |                                   |
| 9.xxx           | QuantityType\<> (number) (Number:...)              | See [documentation on UOM](/docs/concepts/units-of-measurement.html) |
...
|                 |                                                     |                                   |
| 13.xxx          | QuantityType\<> (number) (Number:...)              | See [documentation on UOM](/docs/concepts/units-of-measurement.html) |
...
|                 |                                                     |                                   |
| 14.xxx          | QuantityType\<> (number) (Number:...)              | See [documentation on UOM](/docs/concepts/units-of-measurement.html) |
