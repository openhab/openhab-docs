...
type: binding
description: '"This binding connects the [Bond Home](https://bondhome.io/) Bridge
  to openHAB using the [BOND V2 Local HTTP API](http://docs-local.appbond.com)."'
...
meta:
  ...
  - property: og:description
    content: '"This binding connects the Bond Home Bridge
---
