...
type: binding
description: '"This binding brings support for internet gateway devices that support
  the TR-064 protocol (e.g. the AVM FritzBox family of routers)."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"This binding brings support for internet gateway devices that support
---
