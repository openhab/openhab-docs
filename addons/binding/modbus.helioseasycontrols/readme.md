...
type: binding
description: '"Helios Heat-Recovery Ventilation devices use a Modbus protocol to communicate
  with different sensors, switches, etc. Some devices come with an integrated web
  interface (easyControls) as well as a Modbus TCP/IP Gateway."'
...
meta:
  ...
  - property: og:description
    content: '"Helios Heat-Recovery Ventilation devices use a Modbus protocol to communicate
---
