...
type: binding
description: The openHAB ChatGPT Binding allows openHAB to communicate with any OpenAI API-compatible service, e.g., OpenAI, OpenRouter, Mistral AI, Ollama, etc. and access large language models like OpenAI's ChatGPT and many more.
