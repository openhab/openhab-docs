...
title: Ntfy - Bindings
type: binding
description: '"The Ntfy binding enables openHAB to publish notifications to Ntfy-compatible
  servers (for example [ntfy.sh](https://ntfy.sh) or a self-hosted ntfy-compatible
  endpoint)."'
...
meta:
  ...
  - property: og:description
    content: '"The Ntfy binding enables openHAB to publish notifications to Ntfy-compatible
---
