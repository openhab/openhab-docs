...
type: binding
description: '"This binding can be used to control the following types of whole house
  multi-zone amplifier systems:"'
logo: images/addons/monopriceaudio.png
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.monopriceaudio/README.md
meta:
  - property: og:title
    content: "Monoprice Whole House Audio - Bindings"
  - property: og:description
    content: '"This binding can be used to control the following types of whole house
---
