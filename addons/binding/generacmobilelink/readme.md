...
type: binding
description: '"This binding communicates with the Generac MobileLink API and reports
  on the status of Generac manufactured generators, including versions resold under
  the brands Eaton, Honeywell and Siemens."'
...
meta:
  ...
  - property: og:description
    content: '"This binding communicates with the Generac MobileLink API and reports
---
