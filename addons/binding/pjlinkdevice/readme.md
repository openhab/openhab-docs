...
type: binding
description: '"This binding allows you to control devices with [PJLink](https://pjlink.jbmia.or.jp/english/)
  support."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"This binding allows you to control devices with PJLink
---
