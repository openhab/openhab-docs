...
There is an alternative method for canvases that use square panels: you can request the layout through a [console command](/docs/administration/console.html). Issue the following command:
