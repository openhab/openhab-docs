...
type: binding
description: '"The Zigbee binding currently does not support the Dresden Elektronik
  Raspbee and ConBee Zigbee dongles."'
...
meta:
  ...
  - property: og:description
    content: '"The Zigbee binding currently does not support the Dresden Elektronik
---
...
To do this log into the [console](/docs/administration/console.html) and use the command `things show` to display the configuration parameters, e.g:
