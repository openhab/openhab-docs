...
Please see the [Items documentation](/docs/configuration/items.html) for a full explanation of configuring items.
...
1. [openHAB configuration documentation](/docs/configuration/index.html)
