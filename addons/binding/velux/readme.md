...
type: binding
description: '"This binding integrates the <B>Velux</B> devices with help of a gateway,
  the <B>Velux Bridge KLF200</B>, which is able to control 200 actuators."'
...
meta:
  - property: og:title
    content: "Velux - Bindings"
  - property: og:description
    content: '"This binding integrates the <B>Velux</B> devices with help of a gateway,
---
