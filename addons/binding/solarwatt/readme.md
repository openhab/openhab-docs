...
type: binding
description: '"Binding to query a [solarwatt](https://www.solarwatt.de/) [energy manager](https://www.solarwatt.de/energie-management/energymanager)
  and read the values of all attached devices."'
...
meta:
  ...
  - property: og:description
    content: '"Binding to query a solarwatt energy manager
---
