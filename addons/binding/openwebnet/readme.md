...
type: binding
description: '"This binding integrates **BTicino / Legrand** **MyHOME &reg; - BUS/SCS**
  and **MyHOME &reg; Radio - Zigbee** wireless devices using the [OpenWebNet](https://en.wikipedia.org/wiki/OpenWebNet)
  protocol."'
...
meta:
  ...
  - property: og:description
    content: '"This binding integrates **BTicino / Legrand** **MyHOME &reg; - BUS/SCS**
---
...
Basic Scenarios and CEN/CEN+ Scenarios channels are [TRIGGER channels](/docs/configuration/rules-dsl.html#channel-based-triggers]): they handle events and do not have a state.
