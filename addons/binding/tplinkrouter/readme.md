...
type: binding
description: '"The tplinkrouter Binding allows monitoring and controlling TP-Link
  routers."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"The tplinkrouter Binding allows monitoring and controlling TP-Link
---
