...
type: binding
description: '"This binding reads temperature values from OneWire bus sensors connected
  to the GPIO bus on a Raspberry Pi."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"This binding reads temperature values from OneWire bus sensors connected
---
