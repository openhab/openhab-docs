...
title: FPP - Bindings
type: binding
description: '"Binding to control Falcon Player (FPP) devices using MQTT and HTTP.
  Status messages are received over MQTT and commands are sent via HTTP."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"Binding to control Falcon Player (FPP) devices using MQTT and HTTP.
---
