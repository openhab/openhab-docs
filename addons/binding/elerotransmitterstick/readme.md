...
type: binding
description: '"Allows to control Elero rollershutters through a connected Elero Transmitter
  Stick."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"Allows to control Elero rollershutters through a connected Elero Transmitter
---
