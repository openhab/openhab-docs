...
type: binding
description: '"openHAB ABB/Busch-free@home binding based on the offical free@home
  local API."'
...
meta:
  ...
  - property: og:description
    content: '"openHAB ABB/Busch-free@home binding based on the offical free@home
---
