...
type: binding
description: '"This binding allows you to notify mobile devices using the [Pushsafer
  API](https://www.pushsafer.com/pushapi)."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"This binding allows you to notify mobile devices using the Pushsafer
---
