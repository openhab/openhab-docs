...
type: binding
description: '"This binding supports the multi-room audio system [AmpliPi](http://www.amplipi.com/)
  from [MicroNova](http://www.micro-nova.com/)."'
...
meta:
  ...
  - property: og:description
    content: '"This binding supports the multi-room audio system AmpliPi
---
