...
To access forecast data stored in persistence from scripts and rules, use the [Persistence Extensions](/docs/configuration/persistence.html#persistence-extensions-in-scripts-and-rules).
