...
type: binding
description: '"The primary goal of the [Network UPS Tools](https://networkupstools.org/)
  (NUT) project is to provide support for power devices, such as uninterruptible power
  supplies (UPS), Power Distribution Units and Solar Controllers."'
...
meta:
  ...
  - property: og:description
    content: '"The primary goal of the Network UPS Tools
---
