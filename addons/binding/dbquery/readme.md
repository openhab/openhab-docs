...
type: binding
description: '"This binding allows creating items from the result of native database
  queries."'
...
meta:
  ...
  - property: og:description
    content: '"This binding allows creating items from the result of native database
---
