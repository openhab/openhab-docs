...
type: binding
description: This binding monitors and manages DD-WRT, OpenWrt, Tomato, and other Linux-based routers and access points via SSH.
logo: images/addons/ddwrt.png
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.ddwrt/README.md
meta:
  - property: og:title
    content: "DD-WRT - Bindings"
  - property: og:description
    content: This binding monitors and manages DD-WRT, OpenWrt, Tomato, and other Linux-based routers and access points via SSH.
---
