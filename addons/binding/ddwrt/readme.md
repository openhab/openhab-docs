...
type: binding
description: '"This binding monitors and manages DD-WRT, OpenWrt, Tomato, and other
  Linux-based routers and access points via SSH."'
...
meta:
  ...
  - property: og:description
    content: '"This binding monitors and manages DD-WRT, OpenWrt, Tomato, and other
---
