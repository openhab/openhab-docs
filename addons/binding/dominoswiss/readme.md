...
type: binding
description: '"This binding allows the control of rollershutters, using an eGate as
  gateway and Dominoswiss radio receivers."'
...
meta:
  ...
  - property: og:description
    content: '"This binding allows the control of rollershutters, using an eGate as
---
