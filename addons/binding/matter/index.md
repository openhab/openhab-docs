...
| thermostat-runningstate-cool                                        | Switch                   | Cooling Running State        | Indicates if the thermostat is currently cooling                                                                                                                                                                                                                     | Climate          | true     |             |                                                                                                                                                                      |
| thermostat-runningstate-coolstage2                                  | Switch                   | Cooling Stage 2 Running State| Indicates if the thermostat is currently cooling with its second stage                                                                                                                                                                                               | Climate          | true     |             |                                                                                                                                                                      |
| thermostat-runningstate-fan                                         | Switch                   | Fan Running State            | Indicates if the thermostat fan is currently running                                                                                                                                                                                                                 | Fan              | true     |             |                                                                                                                                                                      |
| thermostat-runningstate-fanstage2                                   | Switch                   | Fan Stage 2 Running State    | Indicates if the thermostat fan is currently running at its second stage                                                                                                                                                                                             | Fan              | true     |             |                                                                                                                                                                      |
| thermostat-runningstate-fanstage3                                   | Switch                   | Fan Stage 3 Running State    | Indicates if the thermostat fan is currently running at its third stage                                                                                                                                                                                              | Fan              | true     |             |                                                                                                                                                                      |
| thermostat-runningstate-heat                                        | Switch                   | Heating Running State        | Indicates if the thermostat is currently heating                                                                                                                                                                                                                     | Heating          | true     |             |                                                                                                                                                                      |
| thermostat-runningstate-heatstage2                                  | Switch                   | Heating Stage 2 Running State| Indicates if the thermostat is currently heating with its second stage                                                                                                                                                                                               | Heating          | true     |             |                                                                                                                                                                      |
...
| valve-close-time                                                    | DateTime                 | Valve Close Time             | The time at which the valve will automatically close, undefined when no automatic close is pending                                                                                                                                                                   | Time             | true     |             |                                                                                                                                                                      |
| valve-current-state                                                 | Number                   | Valve Current State          | The current state of the valve, including the transitioning state while it is opening or closing                                                                                                                                                                     | Flow             | true     |             | 0=Closed, 1=Open, 2=Transitioning                                                                                                                                    |
| valve-duration                                                      | Number:Time              | Valve Open Duration          | The default duration the valve remains open before automatically closing. Set to 0 to clear it, so the valve remains open until it is closed.                                                                                                                        | Time             |          | %d %unit%   |                                                                                                                                                                      |
| valve-fault                                                         | Trigger                  | Valve Fault                  | Event that fires when the valve registers a fault                                                                                                                                                                                                                    |                  |          |             | generalFault, blocked, leaking, notConnected, shortCircuit, currentExceeded                                                                                          |
| valve-level                                                         | Dimmer                   | Valve Level                  | Sets and reflects the valve level as a percentage, for valves that support level control                                                                                                                                                                             | Flow             |          | %.0f %%     |                                                                                                                                                                      |
| valve-state                                                         | Switch                   | Valve State                  | Opens and closes the valve and reflects its current state                                                                                                                                                                                                            | Flow             |          |             |                                                                                                                                                                      |
| valve-target-state                                                  | Number                   | Valve Target State           | The state the valve is moving toward while it is opening or closing, undefined once it has settled                                                                                                                                                                   | Flow             | true     |             | 0=Closed, 1=Open                                                                                                                                                     |
...
| Water Valve                   | 0x0042           | Valve Configuration and Control (0x0081)                                                                                                              |
