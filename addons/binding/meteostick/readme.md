...
type: binding
description: '"This is the binding for the [Meteostick](https://www.smartbedded.com/wiki/index.php/Meteostick)
  weather receiver dongle."'
...
meta:
  ...
  - property: og:description
    content: '"This is the binding for the Meteostick
---
