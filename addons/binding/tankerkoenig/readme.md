...
This switch can be set either manually (only suggested for testing!) or by a rule which uses the [ephemeris action](/docs/configuration/actions.html#ephemeris) to set that switch.
