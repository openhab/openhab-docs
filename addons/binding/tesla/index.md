...
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.tesla/README.md
meta:
  - property: og:title
    content: "Tesla - Bindings"
  - property: og:description
    content: This binding integrates Tesla Electrical Vehicles.
---
...
| centerdisplay            | Number                   | Central Display State       | Indicates the state of the central display, see the [Unofficial Tesla API documentation](https://tesla-api.timdorr.com/vehicle/state/vehiclestate) |
