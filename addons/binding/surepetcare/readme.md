...
type: binding
description: '"This binding integrates with the Sure Petcare API, supporting cloud‑connected
  pet/cat flaps, feeders, and waterstations."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"This binding integrates with the Sure Petcare API, supporting cloud‑connected
---
