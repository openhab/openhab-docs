...
type: binding
description: '"This binding provides integration with any Russound system that support
  the RIO protocol (all MCA systems, all X systems)."'
logo: images/addons/russound.png
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.russound/README.md
meta:
  - property: og:title
    content: "Russound - Bindings"
  - property: og:description
    content: '"This binding provides integration with any Russound system that support
---
