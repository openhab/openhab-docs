...
| self-driving-percentage | Number:Dimensionless | Self-Driving Percentage | Percentage of driving that is on FSD                                                        |
...
| miles-since-reset              | Number:Length            | Driving Distance              | Driving distance since reset                                                                             |
...
| self-driving-miles-since-reset | Number:Length            | Self-Driving Distance         | Self Driving distance since reset                                                                        |
