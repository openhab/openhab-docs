...
id: loqed
label: LOQED
title: LOQED - Bindings
type: binding
description: The LOQED binding controls LOQED Touch and LOQED Pure smart locks either through the cloud Integrations API or directly through a LOQED Bridge on the local network.
install: manual
source: https://github.com/openhab/openhab-addons/blob/main/bundles/org.openhab.binding.loqed/README.md
meta:
  - property: og:title
    content: "LOQED - Bindings"
  - property: og:description
    content: The LOQED binding controls LOQED Touch and LOQED Pure smart locks either through the cloud Integrations API or directly through a LOQED Bridge on the local network.
---
