...
type: binding
description: '"The Remote openHAB binding allows to communicate with remote openHAB
  servers."'
install: manual
...
meta:
  ...
  - property: og:description
    content: '"The Remote openHAB binding allows to communicate with remote openHAB
---
