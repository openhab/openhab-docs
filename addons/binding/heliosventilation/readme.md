...
Setup the device as described in </docs/administration/serial.html>.
...
The binding requires access to the serial device connecting to the RS485 bus as described in </docs/administration/serial.html>.
