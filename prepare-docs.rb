...
require_relative './.vuepress/process_file'
...
if Dir.exist?('addons/integrations')
...
verbose '   ➡️ images'
# FileUtils.cp_r("./configuration/yaml/images", "docs/configuration/yaml/") // no images placed yet
