...
Things are connected to openHAB through [bindings](/addons.html).
...
Please check each individual binding's [documentation](/addons.html) for details on what and how to define Things using the `*.things` configuration text files.
