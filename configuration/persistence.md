...
| `<item>.evolutionRate(ZonedDateTime, ZonedDateTime)`  | Gets the evolution rate of the state of a given {@link Item} between certain points in time (returns DecimalType)                                                           |
