...
| `ImperialUnits` | `org.openhab.core.library.unit.Units` |
| `MetricPrefix` | `org.openhab.core.library.unit.Units` |
| `Units` | `org.openhab.core.library.unit.Units` |
| `BinaryPrefix` | `org.openhab.core.library.unit.Units` |
...
- [Scripted Rule Support](https://github.com/eclipse/openhab/wiki/Scripted-Rule-Support) -
