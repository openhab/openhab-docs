...
They do not reflect the status of a real-world Thing such as whether a light is "ON" or "OFF".
If you are looking to transform Item data generated by a Thing into a meaningful output (e.g. display the status of a door contact, for example, a [Text element](#element-type-text) with it's label parameter may be a better choice.
