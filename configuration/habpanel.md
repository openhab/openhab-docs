...
title: Designing dashboard interfaces with HABPanel
---
...
![Custom widget context menu](images/habpanel_custom-widget-context-menu.png)
...
_This chapter will cover in detail how to write templates in the Template widget, or to build custom widgets. It is not yet published, in the meantime please use the resources below:_
