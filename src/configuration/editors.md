...
How to setup and use Samba on a Linux system is described in the [Linux article](/installation/linux.html#network-sharing).
If you are using [openHABian](/installation/openhabian.html), the network shares are readily configured for you, you only need to mount them locally.
