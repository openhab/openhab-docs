...
1. **Compatible Interpreter**: You need a [LLM-based HLI service](/configuration/multimedia.html#llm-based-interpreters), such as [Google Gemini](/addons/bindings/gemini/).
