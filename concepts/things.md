...
<tr valign="top">                                  <td>CONFIGURATION_ERROR</td><td>An issue with the configuration of a Thing prevents communicating with the represented device or service. This issue might be solved by reconfiguring the Thing.</td></tr>
