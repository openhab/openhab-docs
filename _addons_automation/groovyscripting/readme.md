...
type: automation
description: "This add-on provides support for [Groovy](https://groovy-lang.org/) 4.0.30 that can be used as a scripting language within automation rules."
...
This add-on provides support for [Groovy](https://groovy-lang.org/) 4.0.30 that can be used as a scripting language within automation rules.
