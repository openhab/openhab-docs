...
Getting this alert level can help you script and automate smarter tasks for water and avoid getting penalized by your district or local council.
...
There is only one channel with this binding labeled `alertlevel` which contains a Number (0–4) to represent the alert level.
