...
type: binding
description: "[Souliss](https://souliss.github.io/) is a networking framework for Arduino and compatible boards, and is designed to let you easily build a smart home that is distributed over multiple boards via Ethernet, WiFi, wireless point-to-point and RS485 bus."
