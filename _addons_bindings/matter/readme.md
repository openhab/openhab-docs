...
| doorlock-alarm                                              | Trigger                  | Door Lock Alarm              | Event that fires when a lock alarm occurs (Lock Jammed=0, Lock Factory Reset=1, Lock Radio Power Cycled=3, Wrong Code Entry Limit=4, Front Escutcheon Removed=5, Door Forced Open=6, Door Ajar=7, Forced User=8)                                                     |                  |          |             | 0=Lock Jammed, 1=Lock Factory Reset, 3=Lock Radio Power Cycled, 4=Wrong Code Entry Limit, 5=Front Escutcheon Removed, 6=Door Forced Open, 7=Door Ajar, 8=Forced User |
| doorlock-doorstate                                          | Contact                  | Door Sensor State            | Door Sensor State                                                                                                                                                                                                                                                    | Door             | true     |             |                                                                                                                                                                      |
| doorlock-lockoperationerror                                 | Trigger                  | Lock Operation Error         | Event that fires when a lock operation error occurs (Lock=0, Unlock=1, Non Access User Event=2, Forced User Event=3, Unlatch=4)                                                                                                                                      |                  |          |             | 0=Lock, 1=Unlock, 2=Non Access User Event, 3=Forced User Event, 4=Unlatch                                                                                            |
...
| smokecoalarm-batteryalert                                   | Number                   | Battery Alert                | Indicates whether the battery power resource fault detection is triggered (0=Normal, 1=Warning, 2=Critical)                                                                                                                                                          | Alarm            | true     |             | 0=Normal, 1=Warning, 2=Critical                                                                                                                                      |
| smokecoalarm-contaminationstate                             | Number                   | Contamination State          | Indicates the contamination level of the smoke sensor (0=Normal, 1=Low, 2=Warning, 3=Critical)                                                                                                                                                                       | Alarm            | true     |             | 0=Normal, 1=Low, 2=Warning, 3=Critical                                                                                                                               |
| smokecoalarm-costate                                        | Number                   | CO Alarm                     | Indicates whether the CO sensor is currently triggering an alarm (0=Normal, 1=Warning, 2=Critical)                                                                                                                                                                   | Alarm            | true     |             | 0=Normal, 1=Warning, 2=Critical                                                                                                                                      |
| smokecoalarm-devicemuted                                    | Number                   | Device Muted                 | Indicates whether the audible expression of the device is currently muted (0=Not Muted, 1=Muted)                                                                                                                                                                     | Alarm            | true     |             | 0=Not Muted, 1=Muted                                                                                                                                                 |
| smokecoalarm-endofservice                                   | Number                   | End Of Service               | Indicates whether the end-of-service has been triggered at the device (0=Normal, 1=Expired)                                                                                                                                                                          | Alarm            | true     |             | 0=Normal, 1=Expired                                                                                                                                                  |
| smokecoalarm-expressedstate                                 | Number                   | Expressed State              | The visibly and audibly expressed alarm state with the highest priority (0=Normal, 1=Smoke Alarm, 2=CO Alarm, 3=Battery Alert, 4=Testing, 5=Hardware Fault, 6=End Of Service, 7=Interconnect Smoke, 8=Interconnect CO)                                               | Alarm            | true     |             | 0=Normal, 1=Smoke Alarm, 2=CO Alarm, 3=Battery Alert, 4=Testing, 5=Hardware Fault, 6=End Of Service, 7=Interconnect Smoke, 8=Interconnect CO                         |
...
| smokecoalarm-interconnectco                                 | Number                   | Interconnect CO Alarm        | Indicates whether the interconnected CO alarm is currently triggering from another device (0=Normal, 1=Warning, 2=Critical)                                                                                                                                          | Alarm            | true     |             | 0=Normal, 1=Warning, 2=Critical                                                                                                                                      |
| smokecoalarm-interconnectsmoke                              | Number                   | Interconnect Smoke Alarm     | Indicates whether the interconnected smoke alarm is currently triggering from another device (0=Normal, 1=Warning, 2=Critical)                                                                                                                                       | Alarm            | true     |             | 0=Normal, 1=Warning, 2=Critical                                                                                                                                      |
| smokecoalarm-smokesensitivity                               | Number                   | Smoke Sensitivity            | Indicates the sensitivity level of the smoke sensor (0=High, 1=Standard, 2=Low)                                                                                                                                                                                      | Alarm            |          |             | 0=High, 1=Standard, 2=Low                                                                                                                                            |
| smokecoalarm-smokestate                                     | Number                   | Smoke Alarm                  | Indicates whether the smoke sensor is currently triggering an alarm (0=Normal, 1=Warning, 2=Critical)                                                                                                                                                                | Alarm            | true     |             | 0=Normal, 1=Warning, 2=Critical                                                                                                                                      |
...
| threadnetworkdiagnostics-routingrole                        | Number                   | Routing Role                 | The Thread routing role (0=Unspecified, 1=Unassigned, 2=Sleepy End Device, 3=End Device, 4=Reed, 5=Router, 6=Leader)                                                                                                                                                 | Network          | true     | %d          | 0=Unspecified, 1=Unassigned, 2=Sleepy End Device, 3=End Device, 4=Reed, 5=Router, 6=Leader                                                                           |
