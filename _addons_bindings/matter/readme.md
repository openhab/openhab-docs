...
| smokecoalarm-batteryalert                                   | Number                   | Battery Alert                | Indicates whether the battery power resource fault detection is triggered (0=Normal, 1=Warning, 2=Critical)                                                                                                                                                          | Alarm            | true     |             |
| smokecoalarm-contaminationstate                             | Number                   | Contamination State          | Indicates the contamination level of the smoke sensor (0=Normal, 1=Low, 2=Warning, 3=Critical)                                                                                                                                                                       | Alarm            | true     |             |
| smokecoalarm-costate                                        | Number                   | CO Alarm                     | Indicates whether the CO sensor is currently triggering an alarm (0=Normal, 1=Warning, 2=Critical)                                                                                                                                                                   | Alarm            | true     |             |
| smokecoalarm-devicemuted                                    | Number                   | Device Muted                 | Indicates whether the audible expression of the device is currently muted (0=Not Muted, 1=Muted)                                                                                                                                                                     | Alarm            | true     |             |
| smokecoalarm-endofservice                                   | Number                   | End Of Service               | Indicates whether the end-of-service has been triggered at the device (0=Normal, 1=Expired)                                                                                                                                                                          | Alarm            | true     |             |
| smokecoalarm-expressedstate                                 | Number                   | Expressed State              | The visibly and audibly expressed alarm state with the highest priority (0=Normal, 1=Smoke Alarm, 2=CO Alarm, 3=Battery Alert, 4=Testing, 5=Hardware Fault, 6=End Of Service, 7=Interconnect Smoke, 8=Interconnect CO)                                               | Alarm            | true     |             |
...
| smokecoalarm-interconnectco                                 | Number                   | Interconnect CO Alarm        | Indicates whether the interconnected CO alarm is currently triggering from another device (0=Normal, 1=Warning, 2=Critical)                                                                                                                                          | Alarm            | true     |             |
| smokecoalarm-interconnectsmoke                              | Number                   | Interconnect Smoke Alarm     | Indicates whether the interconnected smoke alarm is currently triggering from another device (0=Normal, 1=Warning, 2=Critical)                                                                                                                                       | Alarm            | true     |             |
| smokecoalarm-smokesensitivity                               | Number                   | Smoke Sensitivity            | Indicates the sensitivity level of the smoke sensor (0=High, 1=Standard, 2=Low)                                                                                                                                                                                      | Alarm            |          |             |
| smokecoalarm-smokestate                                     | Number                   | Smoke Alarm                  | Indicates whether the smoke sensor is currently triggering an alarm (0=Normal, 1=Warning, 2=Critical)                                                                                                                                                                | Alarm            | true     |             |
