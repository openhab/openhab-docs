...
title: 10000322-039 - ZWave
---

{% include base.html %}

# 10000322-039 Switch IO: On/Off Power Switch
This describes the Z-Wave device *10000322-039*, manufactured by *SimonTech S.L.U* with the thing type UID of ```simontech_10000322039_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![10000322-039 product image](https://www.cd-jackson.com/zwave_device_uploads/925/925_default.jpg)


The 10000322-039 supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data between other devices in the mesh network.
...
The following table summarises the channels available for the 10000322-039 -:
...
The following table provides a summary of the 7 configuration parameters available in the 10000322-039.
...
The 10000322-039 supports 1 association group.
