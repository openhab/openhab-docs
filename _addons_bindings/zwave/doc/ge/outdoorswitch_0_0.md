...
The following table provides a summary of the 0 configuration parameter available in the GE Outdoor Switch.
...
The GE Outdoor Switch supports 0 association group.
