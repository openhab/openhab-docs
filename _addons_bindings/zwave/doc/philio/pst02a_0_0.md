...
The following table provides a summary of the 25 configuration parameters available in the PST02A.
...
| 5 | Operation Mode | Mode of operation |
| 5 | Door/window function | Enable or disable the door/window function |
| 5 | Temperature unit | The temperature unit |
| 5 | Illumination report after event triggered | Enable or disable the illumination report after event triggered |
| 5 | Temperature report after event triggered | Enable or disable the temperature report after event triggered |
| 5 | Back key release test mode | Enable or disable the back key release into test mode |
| 6 | Multi-Sensor Function Switch | Enable or disable functions of the multisensor. |
| 7 | Sending motion OFF report | Enable or disable sending motion OFF report |
| 7 | PIR super sensitivity mode | Enable PIR super sensitivity mode |
| 7 | Sending BASIC OFF after door/window is closed | Enable or disable sending BASIC OFF after door/window is closed |
| 7 | Notification type | The Notification type |
| 7 | Multi CC in auto report | Enable or disable Multi CC in auto report |
| 7 | Reporting battery state when the device is triggered | Enable or disable reporting battery state when the device is triggered |
...
Setting the BASIC command value to turn on the light.
  ...
  * -1 = turns on the light. (Default)
The following option values may be configured -:

| Value  | Description |
|--------|-------------|
| -1 | Turn light ON (default) |
| 0 | Turn light OFF |

The manufacturer defined default value is ```-1``` (Turn light ON (default)).
...
Mode of operation
device mode. 0 = normal mode; 1 = test mode.
...
### Parameter 5: Door/window function

Enable or disable the door/window function
disable the door/window function. 0 = enabled; 1 = disabled.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
temperature unit. 0 = Fahrenheit; 1 = Celcius.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
### Parameter 5: Illumination report after event triggered

Enable or disable the illumination report after event triggered
disable the illumination report after event triggered. 0 = enabled; 1 = disabled.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
### Parameter 5: Temperature report after event triggered

Enable or disable the temperature report after event triggered
disable the temperature report after event triggered. 0 = enabled; 1 = disabled.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
### Parameter 5: Back key release test mode

Enable or disable the back key release into test mode
disable the back key release into test mode. 0 = enabled; 1 = disabled.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
This parameter has the configuration ID ```config_5_0_00000080``` and is of type ```INTEGER```.
...
### Parameter 7: Sending motion OFF report

Enable or disable sending motion OFF report
Enable sending motion OFF report. 0=Disable; 1=Enable. 

Note: Depends on the Notification Type, see below:

* Notification type is notification report: Report Notification CC, Type: 0x07, Event: 0xFE.  
* Notification type is sensor binary report: Sensor Binary Report, Type: 0x0C, Value: 0x00.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
### Parameter 7: PIR super sensitivity mode

Enable PIR super sensitivity mode
Enable PIR super sensitivity mode. 0=Disable; 1=Enable.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
### Parameter 7: Sending BASIC OFF after door/window is closed

Enable or disable sending BASIC OFF after door/window is closed
Disable sending BASIC OFF after door/window is closed. 1=Disable, 0=Enable.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
Sensor Binary Report is recommended.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
The manufacturer defined default value is ```1``` (Using Sensor Binary Report).
...
Enable or disable Multi CC in auto report
...
### Parameter 7: Reporting battery state when the device is triggered

Enable or disable reporting battery state when the device is triggered
Disable reporting battery state when the device is triggered. 1=Disable; 0=Enable.
The following option values may be configured, in addition to values in the range 0 to 1 -:
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/168/reference/PST02-Manual-2014-09-17.pdf)
