...
# ZW111 Nano Dimmer
This describes the Z-Wave device *ZW111*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```aeon_zw111_00_000```.
This version of the device is limited to firmware versions below 2.2

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW111 product image](https://opensmarthouse.org/zwavedatabase/576/image/)
...
* [Engineering Manual](https://opensmarthouse.org/zwavedatabase/576/reference/22-Nano-Dimmer-Engineering--20170601-.pdf)
* [User Manual](https://opensmarthouse.org/zwavedatabase/576/reference/Nano-Dimmer-Manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/576).
