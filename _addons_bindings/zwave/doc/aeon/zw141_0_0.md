...
title: Nano Shutter Controller - ZWave
---

{% include base.html %}

# Nano Shutter Controller ZW141
This describes the Z-Wave device *Nano Shutter Controller*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```aeon_zw141_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![Nano Shutter Controller product image](https://www.cd-jackson.com/zwave_device_uploads/912/912_default.png)


The Nano Shutter Controller supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data from other devices.
...
The following table provides a summary of the 6 configuration parameters available in the Nano Shutter Controller.
...
* [manual](https://www.cd-jackson.com/zwave_device_uploads/912/Aeon-Labs-Nano-Shutter--manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/912).
