...
| Input 1 | switch_binary1 | Switch | Switch | 
| Input 2 | switch_binary2 | Switch | Switch | 
| Sensor (temperature) 7 | sensor_temperature7 | Temperature | Number:Temperature | 
...
The ```sensor_temperature7``` channel supports the ```Number:Temperature``` item and is in the ```Temperature``` category.
