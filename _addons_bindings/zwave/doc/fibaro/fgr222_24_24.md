...
| Shutter position | blinds_shutter | Blinds | Dimmer | 
| Lamella position | blinds_lamella | Blinds | Dimmer | 
...
The ```blinds_shutter``` channel supports the ```Dimmer``` item and is in the ```Blinds``` category.

### Lamella position

Sets the blinds lamella position.

The ```blinds_lamella``` channel supports the ```Dimmer``` item and is in the ```Blinds``` category.



## Device Configuration

The following table provides a summary of the 21 configuration parameters available in the FGR222.
...
Enables/disables protection of local push button.  
