...
| 10 | Time of AUTOMATIC moving between extreme dimming values | Time of autom. moving the dimmer between min/max |
...
| 2 | Map OFF status to all devices in group 1, 100% brightness |
...
### Parameter 10: Time of AUTOMATIC moving between extreme dimming values
...
* [FGD211 EN 1.4-1.8](https://www.cd-jackson.com/zwave_device_uploads/117/FGD-211-EN-A-v1-4-1-8.pdf)
