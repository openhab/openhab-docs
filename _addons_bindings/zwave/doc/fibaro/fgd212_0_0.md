...
| Alarm (Power) | alarm_power1 | Door | Switch | 
| Alarm (Heat) | alarm_heat1 |  | Switch | 
...
Dimmer 2 features self-temperature measurement function. In case of reaching critical temperature, the load is turned off and the gate-way receives an information about exceeding maximum temperature of the module.
