...
This describes the Z-Wave device *FGWPB-121*, manufactured by *Fibargroup* with the thing type UID of ```fibaro_fgwpb121_00_000```.
...
You can [edit the database here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/808).
