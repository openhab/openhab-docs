...
# FT116 In-Wall Smart Switch
This describes the Z-Wave device *FT116*, manufactured by *[Fantem](http://www.oomi.com/)* with the thing type UID of ```oomi_ft116_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FT116 product image](https://www.cd-jackson.com/zwave_device_uploads/890/890_default.jpg)
...
The following table provides a summary of the 28 configuration parameters available in the FT116.
...
* [FT116C Manual](https://www.cd-jackson.com/zwave_device_uploads/890/Oomi-In-Wall-Switch-manual--FT116-D----2.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/890).
