...
## Channels
The following table summarises the channels available for the PlugInSwitch
...
The following table provides a summary of the 0 configuration parameter available in the PlugInSwitch.
...
The PlugInSwitch supports 0 association group.
