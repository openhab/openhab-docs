...
Siren 6 is your home’s smart indoor siren. Built with Z-Wave Plus S2 to be a smart home security siren, it features a 110dB speaker coupled with 1,000 lumens visual light alert strobe. Can be used as siren for security alarm, smoke sensor, and CO sensors via Z-Wave
...
Light Effect Index for Endpoint 2 (Tampering)This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
Light Effect Index for Endpoint 4 (Doorbell 2)This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
Light Effect Index for Endpoint 5 (Doorbell 3) .This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
Tone Play Count for Endpoint 6 (Environment)This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
Light Effect for Endpoint 6 (Environment)This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
Light Effect Index for Endpoint 7 (Security)This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
Light Effect Index for Endpoint 8 (Emergency)This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
# Note:
  ...
  3. Indicator Light will quickly flash white light 3 times when Unpairing Button Mode finishesThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
Note:
  ...
  3. Each successful pairing will overwrite the previous paired Button which has the same Button Number.This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
