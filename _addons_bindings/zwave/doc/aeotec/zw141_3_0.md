...
The following table provides a summary of the 18 configuration parameters available in the ZW141.
Detailed information on each parameter can be found in the sections below.

| Param | Name  | Description |
|-------|-------|-------------|
| 20 | Motor Behaviour | Motor behavior after Power ON |
| 22 | Motor Direction | Determine motor run direction |
...
| 85 | External Switch Mode | Set external switch mode |
...
<table>
  <tr>
    ...
    <td>
      <p>
        Change the mapping of output and motor running direction<br />between the 2 directions below:
      </p>
      
      <p>
        a. Out1 maps forward and Out2 maps reverse<br />b. Out1 maps reverse and Out2 maps forward
      </p>
    </td>
  </tr>
</table>
...
Note:
  ...
  * This configuration will not change after network exclusion or Configuration Reset.
...
Product will enter the right Curtain Mode after calibration, see configuration parameter 39.This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
2. This configuration will not change after network exclusion or Configuration Reset.
The following option values may be configured -:
...
The manufacturer defined default value is ```0``` (Mode 1 (Default)).
...
The manufacturer defined default value is ```1``` (Enable (Defaul)).
...
Reset function
Note:  
Parameter 0x16, 0x22, 0x23, 0x24, 0x25, 0x27, 0x28 will not reset to default  
value by this command.This is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
* [Aeotec Engineering Specification (SPEC-ZW141)](https://www.cd-jackson.com/zwave_device_uploads/1151/ES---Nano-Shutter-ZW141-V3-0.pdf)
