...
title: ZWA002-A Aeotec LED Bulb 6 Multi-Color - ZWave
---

{% include base.html %}

# ZWA002-A Aeotec LED Bulb 6 Multi-Color Aeotec LED Bulb 6 Multi-Color, Z-Wave Plus RGBW Dimmable & Multi-Color Changing, 9W, 60 watt Incandescent Equivalent, Smart Light Bulb,A19,E
This describes the Z-Wave device *ZWA002-A Aeotec LED Bulb 6 Multi-Color*, manufactured by *Aeotec Limited* with the thing type UID of ```aeotec_zwa002a_00_000```.

The device is in the category of *Light Bulb*, defining Devices that illuminate something, such as bulbs, etc..

![ZWA002-A Aeotec LED Bulb 6 Multi-Color product image](https://www.cd-jackson.com/zwave_device_uploads/949/949_default.png)


The ZWA002-A Aeotec LED Bulb 6 Multi-Color supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data between other devices in the mesh network.
...
The following table summarises the channels available for the ZWA002-A Aeotec LED Bulb 6 Multi-Color -:
...
The following table provides a summary of the 8 configuration parameters available in the ZWA002-A Aeotec LED Bulb 6 Multi-Color.
...
The ZWA002-A Aeotec LED Bulb 6 Multi-Color supports 1 association group.
