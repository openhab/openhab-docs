...
The following table provides a summary of the 13 configuration parameters available in the ZWA008.
...
| 9 | Time Delay of ‘Off‘ command frame | Time Delay of ‘Off‘ command frame |
