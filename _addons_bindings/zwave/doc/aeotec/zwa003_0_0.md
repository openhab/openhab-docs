...
The following table provides a summary of the 2 configuration parameters available in the Aeotec NanoMote Quad.
...
The Aeotec NanoMote Quad supports 9 association groups.
