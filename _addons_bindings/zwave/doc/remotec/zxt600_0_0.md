...
# ZXT-600 AC Master
This describes the Z-Wave device *ZXT-600*, manufactured by *Remotec* with the thing type UID of ```remotec_zxt600_00_000```.
...
The ZXT-600 supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data from other devices.
