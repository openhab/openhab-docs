...
The following table provides a summary of the 4 configuration parameters available in the ZSE29.
...
The following option values may be configured, in addition to values in the range 0 to 900 -:
