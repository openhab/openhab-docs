...
### Group 2: Basic Set (main)

Basic Set
Main button basic set (pressed only, doesn’t send anything when switch turned on via hub)

Association group 2 supports 5 nodes.

### Group 3: Multilevel (main)

Multilevel
Main button multilevel (held)
