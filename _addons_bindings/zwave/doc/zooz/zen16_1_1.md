...
|--------------|------------|--------------|----------|-----------|
| Delete | switch_binary | switch_binary | Switch | Switch | 
| Delete | switch_dimmer | switch_dimmer | DimmableLight | Dimmer | 
| Delete | scene_number | scene_number |  | Number | 
| Delete | sensor_binary | sensor_binary |  | Switch | 
| Delete | meter_kwh | meter_kwh | Energy | Number | 
| Delete | meter_kvah | meter_kvah | Energy | Number | 
| Delete | meter_watts | meter_watts | Energy | Number | 
