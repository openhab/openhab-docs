...
This version of the device is limited to firmware versions below 1.3

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZEN15 product image](https://opensmarthouse.org/zwavedatabase/758/image/)
...
* [ZEN15 Manual](https://opensmarthouse.org/zwavedatabase/758/reference/zooz-z-wave-plus-power-switch-zen15-user-manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/758).
