...
| Reset Meter | meter_reset3 | Energy | Switch | 
...
| Reset Meter | meter_reset4 | Energy | Switch | 
...
| Reset Meter | meter_reset5 | Energy | Switch | 
...
The ```meter_reset1``` channel supports the ```Switch``` item and is in the ```Energy``` category.
...
The ```meter_reset2``` channel supports the ```Switch``` item and is in the ```Energy``` category.
...
The ```meter_reset3``` channel supports the ```Switch``` item and is in the ```Energy``` category.
...
The ```meter_reset4``` channel supports the ```Switch``` item and is in the ```Energy``` category.
...
The ```meter_reset5``` channel supports the ```Switch``` item and is in the ```Energy``` category.
