...
This describes the Z-Wave device *ZSE40 v2*, manufactured by *[Zooz](http://www.getzooz.com/)* with the thing type UID of ```zooz_zse40v2179_17_009```.
This version of the device is limited to firmware version 17.9

The device is in the category of *Sensor*, defining Device used to measure something.

![ZSE40 v2 product image](https://www.cd-jackson.com/zwave_device_uploads/1277/1277_default.jpg)
...
Use it to set trigger interval - the time when motion is reported again after initial trigger. Values: 15 - 60 where 1 stands for 1 second and 60 stands for 60 seconds. Default set to 15 seconds. NOTE: Small interval will increase activity and decrease battery life. 
Values in the range 15 to 60 may be set.
...
* [Manual](https://www.cd-jackson.com/zwave_device_uploads/1277/zooz-z-wave-plus-4-in-1-sensor-zse40-ver2-manual.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/1277).
