...
(if Multilevel Sensor is supported)

Audio Speaker for custom sound playback

(if Sound Switch is supported)

S2 security protocol and the latest 500 Z-Wave chip for faster and safer
...
the Z-Wave button 3 times quickly
...
3. Click the Z-Wave button on the Multisiren 3 times quickly to finalize

the process.

4. Your hub will confirm exclusion and the device will disappear from
