...
This version of the device is limited to firmware versions 1.8 to 1.91

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![TF016 product image](https://opensmarthouse.org/zwavedatabase/412/image/)
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/412/reference/Manual-Heatit-Z-Wave-Ver2016-A-juni.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/412).
