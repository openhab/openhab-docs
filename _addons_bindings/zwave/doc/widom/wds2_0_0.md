...
| 11 | Timer to switch ON the Channel 2 | Defines the time after which the Channel 2 is switched ON |
...
| Value  | Description |
|--------|-------------|
| 0 | DISABLED - Local Control disabled |
| 1 | ONE_CLICK- 1 click controls the local load |
| 2 | TWO_CLICKS - 2 clicks control the local load |
| 4 | THREE_CLICKS - 3 clicks control the local load |
...
### Parameter 11: Timer to switch ON the Channel 2
