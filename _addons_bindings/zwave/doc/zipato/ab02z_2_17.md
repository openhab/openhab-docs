...
# AB02Z Siren
This describes the Z-Wave device *AB02Z*, manufactured by *[Zipato](http://www.zipato.com/)* with the thing type UID of ```zipato_ab02z_02_017```.
This version of the device is limited to firmware versions above 2.17
