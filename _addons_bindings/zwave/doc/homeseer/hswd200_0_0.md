...
| Normal mode LED colour | config_decimal |  | Number | 
| Status mode LED 1 Colour | config_decimal |  | Number | 
| Status mode LED 2 Colour | config_decimal |  | Number | 
| Status mode LED 3 Colour | config_decimal |  | Number | 
| Status mode LED 4 Colour | config_decimal |  | Number | 
| Status mode LED 5 Colour | config_decimal |  | Number | 
| Status mode LED 6 Colour | config_decimal |  | Number | 
| Status mode LED 7 Colour | config_decimal |  | Number | 
