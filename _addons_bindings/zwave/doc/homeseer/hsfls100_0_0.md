...
| Lux sensor threshold  [Deprecated]| config_decimal | config_decimal |  | Number | 
| Auto Report luminance interval  [Deprecated]| config_decimal | config_decimal |  | Number | 
...
### Lux sensor threshold [Deprecated]
...
### Auto Report luminance interval [Deprecated]
Default: 10
