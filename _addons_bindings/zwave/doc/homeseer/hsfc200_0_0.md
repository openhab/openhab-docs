...
This parameter has the configuration ID ```config_31_1_00000007``` and is of type ```INTEGER```.
...
* [HS-FC200+ User Manual](https://opensmarthouse.org/zwavedatabase/957/reference/HS-FC200-Manual-Online-072318.pdf)
