...
| Mode of Operation  [Deprecated]| config_decimal | config_decimal |  | Number | 
| Status LED Color  [Deprecated]| config_decimal | config_decimal |  | Number | 
| Switch LED Blink Frequency  [Deprecated]| config_decimal | config_decimal |  | Number | 
...
### Switch LED Blink Frequency [Deprecated]
