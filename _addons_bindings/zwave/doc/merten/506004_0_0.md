...
|--------------|------------|--------------|----------|-----------|
| state | sensor_binary | sensor_binary |  | Switch | 
...
The following table provides a summary of the 6 configuration parameters available in the 506004.
...
This parameter has the configuration ID ```config_99_0``` and is of type ```INTEGER```.
