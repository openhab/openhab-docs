...
**Caution:** When dimmed at the lowest setting, even though the load looks like its off, it still has power. Tap bottom of switch to turn off completely. It is best to turn off the power at the circuit breaker to service the load. 
...
The switch will respond to BASIC and BINARY commands that are part of the Z-Wave system. refer to your controller's instructions as to whether your conrtoller can transmit those commands. 
