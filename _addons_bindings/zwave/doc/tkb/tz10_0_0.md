...
## Channels
The following table summarises the channels available for the TZ 10
...
The following table provides a summary of the 0 configuration parameter available in the TZ 10.
...
The TZ 10 supports 1 association group.
