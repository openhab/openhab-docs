...
| Input (temperature) 1 | sensor_temperature11 | Temperature | Number:Temperature | 
| Input (temperature) 2 | sensor_temperature12 | Temperature | Number:Temperature | 
| Input (temperature) 3 | sensor_temperature13 | Temperature | Number:Temperature | 
| Input (temperature) 4 | sensor_temperature14 | Temperature | Number:Temperature | 
