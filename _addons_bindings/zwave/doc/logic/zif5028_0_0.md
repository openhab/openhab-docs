...
![ZIF5028 / HeatIt Z-DIN 616 product image](https://opensmarthouse.org/zwavedatabase/1000/image/)
...
The inclusion mode / exclusion mode on the Logic Group ZIF5028/Heatit Z-DIN 616 device is activated by pressing the small button through the hole in the front of the module, marked ”INCLUSION”, after which the status LED will start flashing.
...
The following table provides a summary of the 24 configuration parameters available in the ZIF5028 / HeatIt Z-DIN 616.
...
| 4 | Timer for input 1 | Configures the timer of input 1 |
| 5 | Function setup of input 2. | Configures the function of input 2. |
| 6 | Timer for input 2 | Configures the timer of input 2 |
| 7 | Function setup of input 3. | Configures the function of input 3. |
| 8 | Timer for input 3 | Configures the timer of input 3 |
| 9 | Function setup of input 4. | Configures the function of input 4. |
| 10 | Timer for input 4 | Configures the timer of input 4 |
| 11 | Function setup of input 5. | Configures the function of input 5. |
| 12 | Timer for input 5 | Configures the timer of input 5 |
| 13 | Function setup of input 6. | Configures the function of input 6. |
| 14 | Timer setup of input 6 | Configures the timer of input 6 |
| 15 | Input Snubber-filter time constant. | The time constant of the input snubber-filter. |
| 16 | Threshold value for activation of inputs. | The time that an entry must be stable before it is accepted as active / idle. |
| 17 | Threshold for input in latched mode. | Time that an input must be activated before it accepts the button latched mode. |
| 18 | Deactivate Central Scene notifications. | Central Scene notifications when the 6 inputs are activated. |
| 19 | Output function, Output 1. | Output 1 can be controlled via Z-Wave or Input 1. |
| 20 | Output function, Output 2. | Output 2 can be controlled via Z-Wave or Input 2. |
| 21 | Output function, Output 3. | Output 3 can be controlled via Z-Wave or Input 3. |
| 22 | Output function, Output 4. | Output 4 can be controlled via Z-Wave or Input 4. |
| 23 | Output function, Output 5. | Output 5 can be controlled via Z-Wave or Input 5. |
| 24 | Output function, Output 6. | Output 6 can be controlled via Z-Wave or Input 6. |
...
### Parameter 4: Timer for input 1

Configures the timer of input 1
...
1 - 127 Time in seconds: 1 – 127 seconds.

128 - 255 Time in minutes: 128 – 255 minutes.
...
### Parameter 5: Function setup of input 2.
...
### Parameter 6: Timer for input 2

Configures the timer of input 2
Choose parameter value from the scheme below.
...
### Parameter 7: Function setup of input 3.
...
### Parameter 8: Timer for input 3

Configures the timer of input 3
Choose parameter value from the scheme below.
...
### Parameter 9: Function setup of input 4.
...
### Parameter 10: Timer for input 4

Configures the timer of input 4
Choose parameter value from the scheme below.
...
### Parameter 11: Function setup of input 5.
...
### Parameter 12: Timer for input 5

Configures the timer of input 5
Choose parameter value from the scheme below.
...
### Parameter 13: Function setup of input 6.
...
### Parameter 14: Timer setup of input 6

Configures the timer of input 6
Choose parameter value from the scheme below.
...
### Parameter 15: Input Snubber-filter time constant.
...
### Parameter 16: Threshold value for activation of inputs.
...
### Parameter 17: Threshold for input in latched mode.
...
### Parameter 18: Deactivate Central Scene notifications.
...
### Parameter 19: Output function, Output 1.
...
### Parameter 20: Output function, Output 2.
...
### Parameter 21: Output function, Output 3.
...
### Parameter 22: Output function, Output 4.
...
### Parameter 23: Output function, Output 5.
...
### Parameter 24: Output function, Output 6.
...
* [Product manual](https://opensmarthouse.org/zwavedatabase/1000/reference/manual-heatit-z-din-616-eng.pdf)
* [ZIF5028 User Manual](https://opensmarthouse.org/zwavedatabase/1000/reference/zif5028-users-manual-en.pdf)
* [ZIF5028 User Manual](https://opensmarthouse.org/zwavedatabase/1000/reference/zif5028-users-manual-en-logic-group.pdf)
* [ZIF5028 User Manual](https://opensmarthouse.org/zwavedatabase/1000/reference/zif5028-users-manual-en-logic-group_1.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/1000).
