...
| 8 | Instant Energy Autosend Interval (METER_REPORT) | Instant Energy Autosend Interval (METER_REPORT) |
| 9 | Instant Energy Autosend Interval (SENSOR_MULTILEVEL_REPORT) | Instant Energy Autosend Interval (SENSOR\_MULTILEVEL\_REPORT) |
| 10 | Accumulated Energy Autosend Interval report (METER_REPORT) | Accumulated Energy Autosend Interval report (METER_REPORT) |
...
Instant Energy Autosend Interval (METER_REPORT)
