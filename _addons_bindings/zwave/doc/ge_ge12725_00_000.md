...
## Channels
The following table summarises the channels available for the GE 12725 In-Wall Dimmer.
...
The following table provides a summary of the configuration parameters available in the GE 12725 In-Wall Dimmer.
...
You can edit the database [here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/486).
