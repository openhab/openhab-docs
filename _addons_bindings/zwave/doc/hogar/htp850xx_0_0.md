...
This describes the Z-Wave device *HTP-8S0-XX*, manufactured by *Hogar Controls* with the thing type UID of ```hogar_htp850xx_00_000```.
...
The following table provides a summary of the 0 configuration parameter available in the HTP-8S0-XX.
...
The HTP-8S0-XX supports 0 association group.
