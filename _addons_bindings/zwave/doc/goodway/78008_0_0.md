...
## Wakeup Information
The Dorr/Window sensor stays in sleep mode for the majority of time. It can be woken up at specified intervals by setting WAKE\_UP\_INTERVAL\_SET command.
...
You can [edit the database here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/827).
