...
![MH-S411 product image](https://opensmarthouse.org/zwavedatabase/279/image/)
...
No device information is provided in the database. Consider [updating the database](https://opensmarthouse.org/zwavedatabase/279) to improve the documentation.
...
* [User Manual](https://opensmarthouse.org/zwavedatabase/279/reference/MH--S411-EU-UM.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://opensmarthouse.org/zwavedatabase/279).
