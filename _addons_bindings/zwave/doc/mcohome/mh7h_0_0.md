...
The MH7H supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data from other devices.
...
|---------|------------|----------|-----------|
| Heating state | switch_binary | Switch | Switch | 
...
| Setpoint (away) | thermostat_setpoint | Temperature | Number:Temperature | 
