...
The following table provides a summary of the 16 configuration parameters available in the IR Thermostat IR2900-ZW.
Detailed information on each parameter can be found in the sections below.

| Param | Name  | Description |
|-------|-------|-------------|
| 0 | Temp. Offset | Temp. Offset |
| 0 | Support Cooling Mode | When Air Conditioner does not have cooling mode, Set this parameter after the device download the IR code from the library |
...
### Parameter 0: Support Cooling Mode
