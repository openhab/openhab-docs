...
The following table provides a summary of the 8 configuration parameters available in the MH-S220.
...
| 8 | Report from Switch 2 to Asso Group 2 | Operation report from Switch 2 to Association Group 2 |
...
0x00 report ON/ OFF operation of Switch 1 to AG 1

0x01 only report ON operation of Switch 1 to AG 1

0x02 only report OFF operation of Switch 1 to AG 1
...
0x00 switching immediately

0x01 Zero-crossing switch
Values in the range 0 to 1 may be set.
...
### Parameter 8: Report from Switch 2 to Asso Group 2

Operation report from Switch 2 to Association Group 2
0x00 report ON/ OFF operation of Switch 2 to AG 2

0x01 only report ON operation of Switch 2 to AG 2

0x02 only report OFF operation of Switch 2 to AG 2
Values in the range 0 to 2 may be set.
