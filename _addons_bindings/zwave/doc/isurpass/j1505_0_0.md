...
# J1505 Motion Sensor
This describes the Z-Wave device *J1505*, manufactured by *Shenzhen iSurpass Technology Co. ,Ltd* with the thing type UID of ```isurpass_j1505_00_000```.

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![J1505 product image](https://www.cd-jackson.com/zwave_device_uploads/965/965_default.jpg)
...
You can [contribute to the database here](http://www.cd-jackson.com/index.php/zwave/zwave-device-database/zwave-device-list/devicesummary/965).
