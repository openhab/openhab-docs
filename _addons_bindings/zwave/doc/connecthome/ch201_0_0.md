...
| 3 | Set point mode |  |
| 4 | Thermostat Status At Failure |  |
| 5 | Max Time Of Data Expectation From Room Temperature Sensor |  |
| 6 | Minimum permissible temperature |  |
| 6 | Minimum permissible temperature |  |
| 7 | The maximum permissible temperature |  |
| 8 | Time turbo mode |  |
| 9 | Power on Turbo Mode |  |
| 10 | Temperature sensor mode |  |
| 11 | Polling period of the room sensor |  |
| 11 | The value that temprature should be changed to send data |  |
| 13 | Interval for forced sending data |  |
| 15 | TYPE OF SWITCH 1 (THERMOSTAT OPERATING MODE) |  |
| 16 | TYPE OF SWITCH 2 (TURBO MODE). |  |
| 40 | ADJUSTMENT OF THE TEMPERATURE SENSOR | In some cases, the location of the temperature sensor, the measured values must be adjusted. |
...
|--------|-------------|
| 0 | Switch on the heating mode at set point, switch off at set point + Δt |
| 1 | Switch on at set point - Δt, switch off at set point; |
| 2 | Switching on at set point - ½ Δt, switching off at set point - ½ Δt (D |

The manufacturer defined default value is ```2``` (Switching on at set point - ½ Δt, switching off at set point - ½ Δt (D).
...
### Parameter 5: Max Time Of Data Expectation From Room Temperature Sensor
...
### Parameter 6: Minimum permissible temperature
...
### Parameter 7: The maximum permissible temperature
...
### Parameter 11: The value that temprature should be changed to send data
...
### Parameter 15: TYPE OF SWITCH 1 (THERMOSTAT OPERATING MODE)
...
### Parameter 16: TYPE OF SWITCH 2 (TURBO MODE).
...
### Parameter 40: ADJUSTMENT OF THE TEMPERATURE SENSOR

In some cases, the location of the temperature sensor, the measured values must be adjusted.
