...
- Samba file sharing with [pre-configured to use shares](http://www.openhab.org/docs/installation/linux.html#mounting-locally)
...
- Switch over to the latest openHAB 2 [*unstable/SNAPSHOT* build](http://www.openhab.org/docs/installation/linux.html#changing-versions)
...
- [Connect to the openHAB 2 dashboard](http://www.openhab.org/docs/configuration/packages.html): [http://openhabianpi:8080](http://openhabianpi:8080)
- [Connect to the Samba network shares](http://www.openhab.org/docs/installation/linux.html#mounting-locally) with username `openhabian` and password `openhabian`
...
- [Connect to the openHAB 2 dashboard](http://www.openhab.org/docs/configuration/packages.html): [http://openhabianpine64:8080](http://openhabianpine64:8080)
- [Connect to the Samba network shares](http://www.openhab.org/docs/installation/linux.html#mounting-locally) with username `openhabian` and password `openhabian`
...
Install [Bindings](https://www.openhab.org/docs/addons/bindings.html), discover your devices, and [configure your smart home](http://www.openhab.org/docs/configuration/index.html).
You might want to start defining [Items](http://www.openhab.org/docs/configuration/items.html), [Sitemap](http://www.openhab.org/docs/configuration/sitemaps.html) and [HABPanel](http://www.openhab.org/docs/addons/uis/habpanel/readme.html) dashboard for your home.
...
Be sure to read up on the [Configuration](http://www.openhab.org/docs/configuration/index.html) section of the documentation page to learn more.
...
- Nginx reverse proxy login (no default, applied when installing) *For manual configuration see [here](http://www.openhab.org/docs/installation/security.html#adding-or-removing-users).*
...
Check the Linux installation article for all needed details: [Linux: Changing Versions](http://www.openhab.org/docs/installation/linux.html#changing-versions)
