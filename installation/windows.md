...
Assuming a successful install, you will now have various folders inside `C:\openHAB3`:
...
```
net stop openHAB3
C:\openHAB3\userdata\bin\openHAB3-service.bat remove
```
- you can delete the whole contents of the C:\openHAB3\ folder.
