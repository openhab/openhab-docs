...
-   **Snapshot Release**
    ...
    The snapshot build is created [almost daily](https://ci.openhab.org), and include the latest changes to the openHAB 2 core and add-ons.
...
Simply download the kar files (the latest builds can be found [here](https://ci.openhab.org)) and move them to the `/opt/openhab2/addons` folder.
