...
The sections below are written for Java 11 but the docs are not updated currently, since we have now secured knowledge about how to install Java 17 on the DiskStation.
